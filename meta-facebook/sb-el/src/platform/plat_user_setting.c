...
temp_threshold_mapping_sensor temp_index_threshold_type_table[] = {
	{ TOP_INLET_LOW_LIMIT, LOCAL_LOW_LIMIT, SENSOR_NUM_TOP_INLET_TEMP_C,
	  "SB_EL_TOP_INLET_TEMP_LOW_LIM" },
	{ TOP_INLET_HIGH_LIMIT, LOCAL_HIGH_LIMIT, SENSOR_NUM_TOP_INLET_TEMP_C,
	  "SB_EL_TOP_INLET_TEMP_HIGH_LIM" },
	{ BOT_INLET_LOW_LIMIT, LOCAL_LOW_LIMIT, SENSOR_NUM_BOT_INLET_TEMP_C,
	  "SB_EL_BOT_INLET_TEMP_LOW_LIM" },
	{ BOT_INLET_HIGH_LIMIT, LOCAL_HIGH_LIMIT, SENSOR_NUM_BOT_INLET_TEMP_C,
	  "SB_EL_BOT_INLET_TEMP_HIGH_LIM" },
	{ BOT_OUTLET_LOW_LIMIT, LOCAL_LOW_LIMIT, SENSOR_NUM_BOT_OUTLET_TEMP_C,
	  "SB_EL_BOT_OUTLET_TEMP_LOW_LIM" },
	{ BOT_OUTLET_HIGH_LIMIT, LOCAL_HIGH_LIMIT, SENSOR_NUM_BOT_OUTLET_TEMP_C,
	  "SB_EL_BOT_OUTLET_TEMP_HIGH_LIM" },
	{ ASIC_NUWA0_SENSOR0_LOW_LIMIT, REMOTE_1_LOW_LIMIT, SENSOR_NUM_ASIC_NUWA0_SENSOR0_TEMP_C,
	  "SB_EL_ASIC_NUWA0_SENSOR0_TEMP_LOW_LIM" },
	{ ASIC_NUWA0_SENSOR0_HIGH_LIMIT, REMOTE_1_HIGH_LIMIT, SENSOR_NUM_ASIC_NUWA0_SENSOR0_TEMP_C,
	  "SB_EL_ASIC_NUWA0_SENSOR0_TEMP_HIGH_LIM" },
	{ ASIC_NUWA0_SENSOR1_LOW_LIMIT, REMOTE_2_LOW_LIMIT, SENSOR_NUM_ASIC_NUWA0_SENSOR1_TEMP_C,
	  "SB_EL_ASIC_NUWA0_SENSOR1_TEMP_LOW_LIM" },
	{ ASIC_NUWA0_SENSOR1_HIGH_LIMIT, REMOTE_2_HIGH_LIMIT, SENSOR_NUM_ASIC_NUWA0_SENSOR1_TEMP_C,
	  "SB_EL_ASIC_NUWA0_SENSOR1_TEMP_HIGH_LIM" },
	{ ASIC_OWL_W_LOW_LIMIT, REMOTE_1_LOW_LIMIT, SENSOR_NUM_ASIC_OWL_W_TEMP_C,
	  "SB_EL_ASIC_OWL_W_TEMP_LOW_LIM" },
	{ ASIC_OWL_W_HIGH_LIMIT, REMOTE_1_HIGH_LIMIT, SENSOR_NUM_ASIC_OWL_W_TEMP_C,
	  "SB_EL_ASIC_OWL_W_TEMP_HIGH_LIM" },
	{ ASIC_OWL_E_LOW_LIMIT, REMOTE_2_LOW_LIMIT, SENSOR_NUM_ASIC_OWL_E_TEMP_C,
	  "SB_EL_ASIC_OWL_E_TEMP_LOW_LIM" },
	{ ASIC_OWL_E_HIGH_LIMIT, REMOTE_2_HIGH_LIMIT, SENSOR_NUM_ASIC_OWL_E_TEMP_C,
	  "SB_EL_ASIC_OWL_E_TEMP_HIGH_LIM" },
	{ ASIC_NUWA1_SENSOR0_LOW_LIMIT, REMOTE_1_LOW_LIMIT, SENSOR_NUM_ASIC_NUWA1_SENSOR0_TEMP_C,
	  "SB_EL_ASIC_NUWA1_SENSOR0_TEMP_LOW_LIM" },
	{ ASIC_NUWA1_SENSOR0_HIGH_LIMIT, REMOTE_1_HIGH_LIMIT, SENSOR_NUM_ASIC_NUWA1_SENSOR0_TEMP_C,
	  "SB_EL_ASIC_NUWA1_SENSOR0_TEMP_HIGH_LIM" },
	{ ASIC_NUWA1_SENSOR1_LOW_LIMIT, REMOTE_2_LOW_LIMIT, SENSOR_NUM_ASIC_NUWA1_SENSOR1_TEMP_C,
	  "SB_EL_ASIC_NUWA1_SENSOR1_TEMP_LOW_LIM" },
	{ ASIC_NUWA1_SENSOR1_HIGH_LIMIT, REMOTE_2_HIGH_LIMIT, SENSOR_NUM_ASIC_NUWA1_SENSOR1_TEMP_C,
	  "SB_EL_ASIC_NUWA1_SENSOR1_TEMP_HIGH_LIM" },
	{ ASIC_HAMSA_CRM_LOW_LIMIT, REMOTE_1_LOW_LIMIT, SENSOR_NUM_ASIC_HAMSA_CRM_TEMP_C,
	  "SB_EL_ASIC_HAMSA_CRM_TEMP_LOW_LIM" },
	{ ASIC_HAMSA_CRM_HIGH_LIMIT, REMOTE_1_HIGH_LIMIT, SENSOR_NUM_ASIC_HAMSA_CRM_TEMP_C,
	  "SB_EL_ASIC_HAMSA_CRM_TEMP_HIGH_LIM" },
	{ ASIC_HAMSA_LS_LOW_LIMIT, REMOTE_2_LOW_LIMIT, SENSOR_NUM_ASIC_HAMSA_LS_TEMP_C,
	  "SB_EL_ASIC_HAMSA_LS_TEMP_LOW_LIM" },
	{ ASIC_HAMSA_LS_HIGH_LIMIT, REMOTE_2_HIGH_LIMIT, SENSOR_NUM_ASIC_HAMSA_LS_TEMP_C,
	  "SB_EL_ASIC_HAMSA_LS_TEMP_HIGH_LIM" },
	{ ASIC_NUWA1_LOCAL_LOW_LIMIT, LOCAL_LOW_LIMIT, SENSOR_NUM_ASIC_NUWA1_LOCAL_TEMP_C,
	  "SB_EL_ASIC_NUWA1_LOCAL_TEMP_LOW_LIM" },
	{ ASIC_NUWA1_LOCAL_HIGH_LIMIT, LOCAL_HIGH_LIMIT, SENSOR_NUM_ASIC_NUWA1_LOCAL_TEMP_C,
	  "SB_EL_ASIC_NUWA1_LOCAL_TEMP_HIGH_LIM" },
	{ ASIC_HAMSA_LOCAL_LOW_LIMIT, LOCAL_LOW_LIMIT, SENSOR_NUM_ASIC_HAMSA_LOCAL_TEMP_C,
	  "SB_EL_ASIC_HAMSA_LOCAL_TEMP_LOW_LIM" },
	{ ASIC_HAMSA_LOCAL_HIGH_LIMIT, LOCAL_HIGH_LIMIT, SENSOR_NUM_ASIC_HAMSA_LOCAL_TEMP_C,
	  "SB_EL_ASIC_HAMSA_LOCAL_TEMP_HIGH_LIM" },
	{ ASIC_NUWA0_LOCAL_LOW_LIMIT, LOCAL_LOW_LIMIT, SENSOR_NUM_ASIC_NUWA0_LOCAL_TEMP_C,
	  "SB_EL_ASIC_NUWA0_LOCAL_TEMP_LOW_LIM" },
	{ ASIC_NUWA0_LOCAL_HIGH_LIMIT, LOCAL_HIGH_LIMIT, SENSOR_NUM_ASIC_NUWA0_LOCAL_TEMP_C,
	  "SB_EL_ASIC_NUWA0_LOCAL_TEMP_HIGH_LIM" },
	{ ASIC_OWL_LOCAL_LOW_LIMIT, LOCAL_LOW_LIMIT, SENSOR_NUM_ASIC_OWL_LOCAL_TEMP_C,
	  "SB_EL_ASIC_OWL_LOCAL_TEMP_LOW_LIM" },
	{ ASIC_OWL_LOCAL_HIGH_LIMIT, LOCAL_HIGH_LIMIT, SENSOR_NUM_ASIC_OWL_LOCAL_TEMP_C,
	  "SB_EL_ASIC_OWL_LOCAL_TEMP_HIGH_LIM" },
};
...
bool temp_threshold_default_settings_init(void)
{
	for (int i = 0; i < PLAT_TEMP_INDEX_THRESHOLD_TYPE_MAX; i++) {
		...
		if (i == ASIC_NUWA0_SENSOR0_HIGH_LIMIT || i == ASIC_NUWA0_SENSOR1_HIGH_LIMIT ||
		    ...
		    i == ASIC_NUWA1_LOCAL_HIGH_LIMIT || i == ASIC_HAMSA_LOCAL_HIGH_LIMIT ||
		    i == ASIC_NUWA0_LOCAL_HIGH_LIMIT || i == ASIC_OWL_LOCAL_HIGH_LIMIT) {
			temperature = 100000;
		}
...
static void svs_voltage_range_default_settings_init(void)
{
...
static bool svs_voltage_range_user_settings_init(void)
{
	...
	for (int i = VR_RAIL_E_ASIC_P0V75_NUWA0_VDD; i <= VR_RAIL_E_ASIC_P0V75_NUWA1_VDD; i++) {
		if (svs_voltage_range_user_settings.vout_max[i] != UINT16_MAX &&
		    svs_voltage_range_user_settings.vout_min[i] != UINT16_MAX) {
...
bool perm_config_clear(void)
{
	...
	/* clear svs voltage range perm parameters */
