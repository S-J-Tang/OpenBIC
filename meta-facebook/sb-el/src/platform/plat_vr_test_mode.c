...
const vr_test_mode_setting_t vr_test_mode_table_default[] = {
	// vr_rail, fast ocp: x/10(A), slow ocp: x/10(A), uvp: 1(mV), ovp: 1(mV), v max: 1(mV), lcr(mV), ucr(mV), vout_default(mV)
	{ VR_RAIL_E_ASIC_P0V75_NUWA0_VDD, 14080, 14080, 640, 940, 940, 653, 940, 750 },
	{ VR_RAIL_E_ASIC_P0V75_NUWA1_VDD, 14300, 14300, 640, 940, 940, 653, 940, 750 },
	...
	{ VR_RAIL_E_ASIC_P0V4_VDDQL_HBM1357, 650, 620, 325, 800, 440, 380, 440, 412 },
	{ VR_RAIL_E_ASIC_P1V05_VDDC_HBM1357, 2200, 2110, 665, 1465, 1465, 1002, 1465, 1065 },
	...
	{ VR_RAIL_E_ASIC_P0V85_HAMSA_VDD, 850, 806, 450, 1250, 1250, 740, 1250, 850 },
	...
	{ VR_RAIL_E_ASIC_P0V9_VDDQ_HBM0246, 1440, 1308, 520, 1320, 1320, 865, 1320, 920 },
	...
	{ VR_RAIL_E_ASIC_P0V4_VDDQL_HBM0246, 650, 624, 325, 800, 440, 380, 440, 412 },
	{ VR_RAIL_E_ASIC_P0V75_VDDPHY_HBM0246, 1200, 1131, 350, 1150, 1150, 690, 1150, 750 },
	{ VR_RAIL_E_ASIC_P0V75_OWL_W_VDD, 1650, 1500, 350, 1150, 1150, 728, 1150, 750 },
	{ VR_RAIL_E_ASIC_P0V75_MAX_S_VDD, 500, 430, 350, 1150, 1150, 728, 1150, 750 },
