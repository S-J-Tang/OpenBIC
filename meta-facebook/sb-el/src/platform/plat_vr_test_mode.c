...
const vr_test_mode_setting_t vr_test_mode_table_default[] = {
	// vr_rail, fast ocp: x/10(A), slow ocp: x/10(A), uvp: 1(mV), ovp: 1(mV), v max: 1(mV), lcr(mV), ucr(mV), vout_default(mV)
	{ VR_RAIL_E_ASIC_P0V75_NUWA0_VDD, 14080, 14080, 640, 940, 940, 653, 940, 749 },
	{ VR_RAIL_E_ASIC_P0V75_NUWA1_VDD, 14300, 14300, 640, 940, 940, 653, 940, 751 },
	{ VR_RAIL_E_ASIC_P0V9_OWL_E_TRVDD, 250, 230, 500, 1300, 1300, 873, 1300, 950 },
	{ VR_RAIL_E_ASIC_P0V75_OWL_E_TRVDD, 140, 120, 350, 1150, 1150, 728, 1150, 748 },
	{ VR_RAIL_E_ASIC_P0V75_MAX_M_VDD, 500, 430, 350, 1150, 1150, 728, 1150, 750 },
	{ VR_RAIL_E_ASIC_P0V75_VDDPHY_HBM1357, 1200, 1131, 350, 1150, 1150, 690, 1150, 750 },
	{ VR_RAIL_E_ASIC_P0V75_OWL_E_VDD, 1650, 1500, 350, 1150, 1150, 728, 1150, 750 },
	{ VR_RAIL_E_ASIC_P0V4_VDDQL_HBM1357, 650, 620, 325, 800, 440, 380, 440, 410 },
	{ VR_RAIL_E_ASIC_P1V05_VDDC_HBM1357, 2200, 2110, 665, 1465, 1465, 1002, 1465, 1064 },
	{ VR_RAIL_E_ASIC_P1V8_VPP_HBM1357, 250, 220, 1400, 2200, 2200, 1692, 2200, 1800 },
	{ VR_RAIL_E_ASIC_P0V9_VDDQ_HBM1357, 1440, 1308, 520, 1320, 1320, 865, 1320, 919 },
	{ VR_RAIL_E_ASIC_P0V85_HAMSA_VDD, 850, 806, 450, 1250, 1250, 740, 1250, 880 },
	{ VR_RAIL_E_ASIC_P0V75_MAX_N_VDD, 500, 430, 350, 1150, 1150, 728, 1150, 748 },
	{ VR_RAIL_E_ASIC_P0V8_HAMSA_AVDD_PCIE, 450, 385, 430, 1230, 1230, 806, 1230, 830 },
	{ VR_RAIL_E_ASIC_P0V9_VDDQ_HBM0246, 1440, 1308, 520, 1320, 1320, 865, 1320, 919 },
	{ VR_RAIL_E_ASIC_P1V2_HAMSA_VDDHRXTX_PCIE, 150, 100, 800, 1600, 1600, 1164, 1600, 1199 },
	{ VR_RAIL_E_ASIC_P1V05_VDDC_HBM0246, 2200, 2110, 665, 1465, 1465, 1002, 1465, 1199 },
	{ VR_RAIL_E_ASIC_P1V8_VPP_HBM0246, 250, 220, 1400, 2200, 2200, 1692, 2200, 1789 },
	{ VR_RAIL_E_ASIC_P0V4_VDDQL_HBM0246, 650, 624, 325, 800, 440, 380, 440, 410 },
	{ VR_RAIL_E_ASIC_P0V75_VDDPHY_HBM0246, 1200, 1131, 350, 1150, 1150, 690, 1150, 750 },
	{ VR_RAIL_E_ASIC_P0V75_OWL_W_VDD, 1650, 1500, 350, 1150, 1150, 728, 1150, 744 },
	{ VR_RAIL_E_ASIC_P0V75_MAX_S_VDD, 500, 430, 350, 1150, 1150, 728, 1150, 742 },
	{ VR_RAIL_E_ASIC_P0V9_OWL_W_TRVDD, 250, 230, 500, 1300, 1300, 873, 1300, 898 },
	{ VR_RAIL_E_ASIC_P0V75_OWL_W_TRVDD, 140, 120, 350, 1150, 1150, 728, 1150, 751 },
};
...
const mps_vr_test_mode_setting_t vr_mps_normal_mode_table[] = {
	...
	*/
	...
	{ VR_RAIL_E_ASIC_P0V75_NUWA1_VDD, 1424, NO_USE, 200, 782, 918, NO_USE, NO_USE, 980, 940,
	  751, 918, NO_USE },
	{ VR_RAIL_E_ASIC_P0V9_OWL_E_TRVDD, 16, 0, 400, 846, 954, NO_USE, NO_USE, 1010, 1055, 950,
	  954, NO_USE },
	{ VR_RAIL_E_ASIC_P0V75_OWL_E_TRVDD, 10, 0, 350, 705, 795, NO_USE, NO_USE, 865, 945, 748,
	  795, NO_USE },
	...
	{ VR_RAIL_E_ASIC_P0V75_OWL_E_VDD, 150, 0, 350, 690, 810, NO_USE, NO_USE, 880, 910, 750, 810,
	  NO_USE },
	{ VR_RAIL_E_ASIC_P0V4_VDDQL_HBM1357, 36, 0, 150, 380, 440, NO_USE, NO_USE, 600, 790, 410,
	  440, NO_USE },
	...
	{ VR_RAIL_E_ASIC_P1V8_VPP_HBM1357, 14, 0, 400, 1746, 1950, NO_USE, NO_USE, 1960, 2000, 1800,
	  1950, NO_USE },
	{ VR_RAIL_E_ASIC_P0V9_VDDQ_HBM1357, 144, 0, 400, 846, 1177, NO_USE, NO_USE, 1020, 1400, 919,
	  1177, NO_USE },
	{ VR_RAIL_E_ASIC_P0V85_HAMSA_VDD, 76, 0, 400, 782, 918, NO_USE, NO_USE, 945, 970, 880, 918,
	  NO_USE },
	{ VR_RAIL_E_ASIC_P0V75_MAX_N_VDD, 57, 0, 350, 690, 848, NO_USE, NO_USE, 890, 950, 748, 848,
	  NO_USE },
	{ VR_RAIL_E_ASIC_P0V8_HAMSA_AVDD_PCIE, 40, 0, 350, 752, 848, NO_USE, NO_USE, 920, 950, 830,
	  848, NO_USE },
	{ VR_RAIL_E_ASIC_P0V9_VDDQ_HBM0246, 144, 0, 400, 846, 1177, NO_USE, NO_USE, 1020, 1400, 919,
	  1177, NO_USE },
	{ VR_RAIL_E_ASIC_P1V2_HAMSA_VDDHRXTX_PCIE, 9, 0, 400, 1128, 1272, NO_USE, NO_USE, 1310,
	  1320, 1199, 1272, NO_USE },
	{ VR_RAIL_E_ASIC_P1V05_VDDC_HBM0246, 270, 0, 400, 987, 1177, NO_USE, NO_USE, 1175, 1550,
	  1199, 1177, NO_USE },
	{ VR_RAIL_E_ASIC_P1V8_VPP_HBM0246, 14, 0, 400, 1746, 1950, NO_USE, NO_USE, 1960, 2000, 1789,
	  1950, NO_USE },
	{ VR_RAIL_E_ASIC_P0V4_VDDQL_HBM0246, 36, 0, 150, 380, 440, NO_USE, NO_USE, 605, 790, 410,
	  440, NO_USE },
	{ VR_RAIL_E_ASIC_P0V75_VDDPHY_HBM0246, 114, 0, 350, 705, 795, NO_USE, NO_USE, 870, 895, 750,
	  795, NO_USE },
	{ VR_RAIL_E_ASIC_P0V75_OWL_W_VDD, 150, 0, 350, 690, 810, NO_USE, NO_USE, 875, 910, 744, 810,
	  NO_USE },
	{ VR_RAIL_E_ASIC_P0V75_MAX_S_VDD, 48, 0, 400, 690, 848, NO_USE, NO_USE, 870, 950, 742, 848,
	  NO_USE },
	{ VR_RAIL_E_ASIC_P0V9_OWL_W_TRVDD, 16, 0, 400, 846, 954, NO_USE, NO_USE, 970, 1055, 898,
	  954, NO_USE },
	{ VR_RAIL_E_ASIC_P0V75_OWL_W_TRVDD, 10, 0, 350, 705, 795, NO_USE, NO_USE, 865, 945, 751,
	  795, NO_USE },
};
//clang-format on
