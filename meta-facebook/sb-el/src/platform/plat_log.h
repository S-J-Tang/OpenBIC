...
enum VR_ERR_LOG_DEVICE_INDEX_E {
	...
	//pwr fault reg 2
	PWRGD_NUWA1_VDD_FAULT,
	PWRGD_NUWA0_VDD_FAULT,
	...
	PWRGD_VDDC_HBM0_HBM2_HBM4_HBM6_R_FAULT,
	PWRGD_VPP_HBM0_HBM2_HBM4_HBM6_R_FAULT,
	PWRGD_VDDPHY_HBM0_HBM2_HBM4_HBM6_R_FAULT,
	PWRGD_VDDQL_HBM1_HBM3_HBM5_HBM7_R_FAULT,
	PWRGD_VDDC_HBM1_HBM3_HBM5_HBM7_R_FAULT,
	PWRGD_VPP_HBM1_HBM3_HBM5_HBM7_R_FAULT,
	PWRGD_VDDPHY_HBM1_HBM3_HBM5_HBM7_R_FAULT,
	//pwr fault reg 4
	PWRGD_VDDQ_HBM0_HBM2_HBM4_HBM6_R_FAULT,
	PWRGD_VDDQ_HBM1_HBM3_HBM5_HBM7_R_FAULT,
	PWRGD_P1V2_PLL_VDDA_OWL_W_FAULT,
	PWRGD_P1V2_PLL_VDDA_SOC_FAULT,
...
enum LOG_ERROR_TRIGGER_CAUSE {
	...
	ASIC_THERMTRIP_TRIGGER_CAUSE = 0b110,
	ASIC_ERROR_TRIGGER_CAUSE = 0b111,
	MAX_TRIGGER_CAUSE = 0b1000, //trigger cause maxium 3 bit
};

// MFIO_FOR_ELECTRA bit positions
#define HAMSA_MFIO22 6 //bit-6
#define NUWA0_MFIO24 3 //bit-3
#define NUWA1_MFIO28 1 //bit-1
#define HAMSA_MFIO23 5 //bit-5
#define NUWA0_MFIO31 2 //bit-2
#define NUWA1_MFIO30 0 //bit-0

#define HAMSA_MFIO22_ERROR_CODE 0x86A8
#define NUWA0_MFIO24_ERROR_CODE 0x83A8
#define NUWA1_MFIO28_ERROR_CODE 0x81A8
