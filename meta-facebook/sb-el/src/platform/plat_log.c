...
vr_ubc_device_table vr_device_table[] = {
	...
	{ VR_INDEX_E_1, SENSOR_NUM_ASIC_P0V85_NUWA1_VDD_TEMP_C },
	{ VR_INDEX_E_2, SENSOR_NUM_ASIC_P0V85_NUWA0_VDD_TEMP_C },
	...
	{ VR_INDEX_E_6, SENSOR_NUM_ASIC_P1V1_VDDQC_HBM1357_TEMP_C,
	  SENSOR_NUM_ASIC_P1V8_VPP_HBM1357_TEMP_C },
	{ VR_INDEX_E_7, SENSOR_NUM_ASIC_P0V75_MAX_N_VDD_TEMP_C,
	  SENSOR_NUM_ASIC_P0V8_HAMSA_AVDD_PCIE_TEMP_C },
	{ VR_INDEX_E_8, SENSOR_NUM_ASIC_P1V2_HAMSA_VDDHRXTX_PCIE_TEMP_C,
	  SENSOR_NUM_ASIC_P0V85_HAMSA_VDD_TEMP_C },
	{ VR_INDEX_E_9, SENSOR_NUM_ASIC_P1V1_VDDQC_HBM0246_TEMP_C,
	  SENSOR_NUM_ASIC_P1V8_VPP_HBM0246_TEMP_C },
	{ VR_INDEX_E_10, SENSOR_NUM_ASIC_P0V4_VDDQL_HBM0246_TEMP_C,
	  SENSOR_NUM_ASIC_P0V75_VDDPHY_HBM0246_TEMP_C },
	{ VR_INDEX_E_11, SENSOR_NUM_ASIC_P0V75_OWL_W_VDD_TEMP_C,
	  SENSOR_NUM_ASIC_P0V75_MAX_S_VDD_TEMP_C },
	{ VR_INDEX_E_12, SENSOR_NUM_ASIC_P0V9_OWL_W_TRVDD_TEMP_C,
...
vr_error_callback_info vr_error_callback_info_table[] = {
	...
	{ VR_POWER_FAULT_1_REG,
	  0xFC,
	  { VR_INDEX_E_3, VR_INDEX_E_12, VR_INDEX_E_3, VR_INDEX_E_12, VR_INDEX_E_7, VR_INDEX_E_8,
	    0x00, 0x00 } },
	{ VR_POWER_FAULT_2_REG,
	  0xFF,
	  { VR_INDEX_E_1, VR_INDEX_E_2, VR_INDEX_E_5, VR_INDEX_E_11, VR_INDEX_E_8, VR_INDEX_E_11,
	    VR_INDEX_E_4, VR_INDEX_E_7 } },
	{ VR_POWER_FAULT_3_REG,
	  0xFF,
	  { VR_INDEX_E_10, VR_INDEX_E_9, VR_INDEX_E_9, VR_INDEX_E_10, VR_INDEX_E_5, VR_INDEX_E_6,
