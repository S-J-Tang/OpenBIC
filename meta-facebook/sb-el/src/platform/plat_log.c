...
vr_device_match_sensor_num vr_error_fault_table[] = {
	...
	{ PWRGD_VDDC_HBM0_HBM2_HBM4_HBM6_R_FAULT, SENSOR_NUM_ASIC_P1V05_VDDC_HBM0246_TEMP_C },
	...
	{ PWRGD_VDDC_HBM1_HBM3_HBM5_HBM7_R_FAULT, SENSOR_NUM_ASIC_P1V05_VDDC_HBM1357_TEMP_C },
	...
	//pwr fault reg 4
	{ PWRGD_VDDQ_HBM0_HBM2_HBM4_HBM6_R_FAULT, SENSOR_NUM_ASIC_P0V9_VDDQ_HBM0246_TEMP_C },
	{ PWRGD_VDDQ_HBM1_HBM3_HBM5_HBM7_R_FAULT, SENSOR_NUM_ASIC_P0V9_VDDQ_HBM1357_TEMP_C },
	{ PWRGD_P1V2_PLL_VDDA_OWL_W_FAULT, 0 }, // TODO
	{ PWRGD_P1V2_PLL_VDDA_SOC_FAULT, 0 }, // TODO
	...
	{ VR_POWER_FAULT_3_REG,
	  {
		  ...
		  PWRGD_VDDC_HBM1_HBM3_HBM5_HBM7_R_FAULT, // bit2
		  ...
		  PWRGD_VDDC_HBM0_HBM2_HBM4_HBM6_R_FAULT, // bit6
	...
	{ VR_POWER_FAULT_4_REG,
	  {
		  ...
		  PWRGD_P1V2_PLL_VDDA_SOC_FAULT, // bit4
		  PWRGD_P1V2_PLL_VDDA_OWL_W_FAULT, // bit5
		  PWRGD_VDDQ_HBM1_HBM3_HBM5_HBM7_R_FAULT, // bit6
		  PWRGD_VDDQ_HBM0_HBM2_HBM4_HBM6_R_FAULT // bit7
	  } }, // to_do not sure
...
void check_rns_vr_cml_status(void)
{
	...
	for (uint8_t rail = 0; rail < VR_RAIL_E_P3V3_OSFP_VOLT_V; rail++) {
		...
		/* STATUS_CML is clear, nothing to do. */
		if (cml_status == 0)
			continue;
		...
		/* Ignore bits 6, 7, 9, 10, and 11. Clear only a standalone CML fault. */
