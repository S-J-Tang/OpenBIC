...
static const power_capping_item_t power_capping_item_list[CAPPING_VR_IDX_MAX * CAPPING_LV_IDX_MAX] = {
	{ "NUWA0_LV1", CAPPING_VR_IDX_NUWA0, CAPPING_LV_IDX_LV1, 0xFF },
	{ "NUWA0_LV2", CAPPING_VR_IDX_NUWA0, CAPPING_LV_IDX_LV2, ADC_IDX_NUWA0_1 },
	{ "NUWA0_LV3", CAPPING_VR_IDX_NUWA0, CAPPING_LV_IDX_LV3, ADC_IDX_NUWA0_2 },
	{ "NUWA1_LV1", CAPPING_VR_IDX_NUWA1, CAPPING_LV_IDX_LV1, 0xFF },
	{ "NUWA1_LV2", CAPPING_VR_IDX_NUWA1, CAPPING_LV_IDX_LV2, ADC_IDX_NUWA1_1 },
	{ "NUWA1_LV3", CAPPING_VR_IDX_NUWA1, CAPPING_LV_IDX_LV3, ADC_IDX_NUWA1_2 },
};
...
static int cmd_power_capping_get_all(const struct shell *shell, size_t argc, char **argv)
{
	...
	const char *volt_str = "NUWA0_VDD_VOLT, NUWA1_VDD_VOLT";
	const char *pwr_str = "NUWA0_VDD_PWR, NUWA1_VDD_PWR";
	...
	shell_print(shell, "---------------------NUWA0---------------------");
	shell_print(shell, "NUWA0 LV1 time window: %4d (us)",
		    get_power_capping_time_w(CAPPING_VR_IDX_NUWA0, CAPPING_LV_IDX_LV1));
	shell_print(shell, "NUWA0 LV1 threshold: %6d (W), %4d (A)\n",
		    get_power_capping_threshold(CAPPING_VR_IDX_NUWA0, CAPPING_LV_IDX_LV1),
		    get_power_capping_current_threshold(CAPPING_VR_IDX_NUWA0));
	shell_print(shell, "NUWA0 LV2 time window: %4d (ms)",
		    get_power_capping_time_w(CAPPING_VR_IDX_NUWA0, CAPPING_LV_IDX_LV2));
	shell_print(shell, "NUWA0 LV2 threshold: %6d (W)",
		    get_power_capping_threshold(CAPPING_VR_IDX_NUWA0, CAPPING_LV_IDX_LV2));
	shell_print(shell, "NUWA0 LV2 avg_power: %6d (W)\n",
		    get_power_capping_avg_power(CAPPING_VR_IDX_NUWA0, CAPPING_LV_IDX_LV2));
	shell_print(shell, "NUWA0 LV3 time window: %4d (ms)",
		    get_power_capping_time_w(CAPPING_VR_IDX_NUWA0, CAPPING_LV_IDX_LV3));
	shell_print(shell, "NUWA0 LV3 threshold: %6d (W)",
		    get_power_capping_threshold(CAPPING_VR_IDX_NUWA0, CAPPING_LV_IDX_LV3));
	shell_print(shell, "NUWA0 LV3 avg_power: %6d (W)\n",
		    get_power_capping_avg_power(CAPPING_VR_IDX_NUWA0, CAPPING_LV_IDX_LV3));
	shell_print(shell, "---------------------NUWA1---------------------");
	shell_print(shell, "NUWA1 LV1 time window: %4d (us)",
		    get_power_capping_time_w(CAPPING_VR_IDX_NUWA1, CAPPING_LV_IDX_LV1));
	shell_print(shell, "NUWA1 LV1 threshold: %6d (W), %4d (A)\n",
		    get_power_capping_threshold(CAPPING_VR_IDX_NUWA1, CAPPING_LV_IDX_LV1),
		    get_power_capping_current_threshold(CAPPING_VR_IDX_NUWA1));
	shell_print(shell, "NUWA1 LV2 time window: %4d (ms)",
		    get_power_capping_time_w(CAPPING_VR_IDX_NUWA1, CAPPING_LV_IDX_LV2));
	shell_print(shell, "NUWA1 LV2 threshold: %6d (W)",
		    get_power_capping_threshold(CAPPING_VR_IDX_NUWA1, CAPPING_LV_IDX_LV2));
	shell_print(shell, "NUWA1 LV2 avg_power: %6d (W)\n",
		    get_power_capping_avg_power(CAPPING_VR_IDX_NUWA1, CAPPING_LV_IDX_LV2));
	shell_print(shell, "NUWA1 LV3 time window: %4d (ms)",
		    get_power_capping_time_w(CAPPING_VR_IDX_NUWA1, CAPPING_LV_IDX_LV3));
	shell_print(shell, "NUWA1 LV3 threshold: %6d (W)",
		    get_power_capping_threshold(CAPPING_VR_IDX_NUWA1, CAPPING_LV_IDX_LV3));
	shell_print(shell, "NUWA1 LV3 avg_power: %6d (W)\n",
		    get_power_capping_avg_power(CAPPING_VR_IDX_NUWA1, CAPPING_LV_IDX_LV3));
	return 0;
}
...
static int cmd_power_capping_set_time_window(const struct shell *shell, size_t argc, char **argv)
{
	...
	if (idx == 0xff) {
		shell_error(shell, "Here is the <NUWA[X]_LV[Y]> list:");
...
static int cmd_power_capping_set_polling_rate(const struct shell *shell, size_t argc, char **argv)
{
	...
	default:
		shell_error(shell,
			    "NUWA0/1_VDD power polling rate should be 10ms, 5ms, 2ms or 1ms");
		return -1;
		break;
	}
...
static int cmd_power_capping_debug(const struct shell *shell, size_t argc, char **argv)
{
	...
	if (idx == 0xff) {
		shell_error(shell, "Should input: <NUWA[X]_LV[Y]>");
		return -1;
	}
...
SHELL_STATIC_SUBCMD_SET_CREATE(
	...
	SHELL_CMD_ARG(time_window, &power_capping_name,
		      "power_capping set time_window <NUWA[X]_LV[Y]> <time>",
		      cmd_power_capping_set_time_window, 3, 0),
	SHELL_CMD_ARG(threshold, &power_capping_name,
		      "power_capping set threshold <NUWA[X]_LV[Y]> <threshold>",
...
SHELL_STATIC_SUBCMD_SET_CREATE(
	...
	SHELL_CMD(set, &set_subcmds,
		  ...
		  NULL),
	SHELL_CMD_ARG(debug, &power_capping_name, "power_capping debug <NUWA[X]_LV[Y]>",
