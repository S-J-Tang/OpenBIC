...
static void print_hex_dump(const struct shell *sh, uint32_t base_addr, const uint8_t *buf,
			   size_t len)
{
...
SHELL_STATIC_SUBCMD_SET_CREATE(
	...
	SHELL_CMD_ARG(write_demo, NULL,
		      ...
		      cmd_write_demo, 1, 0),
	SHELL_CMD_ARG(erase, NULL, "Erase 4KB at addr 0x0", cmd_erase, 1, 0),
	SHELL_CMD_ARG(read, NULL, "Read 32 bytes from addr 0x0", cmd_read, 1, 0),
