...
#define BOT_OUTLET_TEMP_ADDR (0X80 >> 1)

#define ASIC_DIE_ATH_SENSOR_0_TEMP_TMP432_ADDR (0X81 >> 1)
#define ASIC_DIE_ATH_SENSOR_1_TEMP_TMP432_ADDR (0X9A >> 1)
#define ASIC_DIE_N_OWL_TEMP_TMP432_ADDR (0X81 >> 1)
#define ASIC_DIE_S_OWL_TEMP_TMP432_ADDR (0X9A >> 1)

#define THERMAL_SENSOR_1_ADDR (0x96 >> 1)
#define THERMAL_SENSOR_2_ADDR (0x98 >> 1)

#define ASIC_DIE_ATH_SENSOR_0_TEMP_EMC1413_ADDR (0XB8 >> 1)
#define ASIC_DIE_ATH_SENSOR_1_TEMP_EMC1413_ADDR (0X38 >> 1)
#define ASIC_DIE_N_OWL_TEMP_EMC1413_ADDR (0XB8 >> 1)
...
#define THERMAL_SENSOR_1_TEMP_C 0x13
#define THERMAL_SENSOR_2_TEMP_C 0x14

#define VR_P3V3_TEMP_C 0x15
#define VR_P3V3_VOLT_V 0x16
#define VR_P3V3_CURR_A 0x17
#define VR_P3V3_PWR_W 0x18

#define VR_ASIC_P0V85_PVDD_TEMP_C 0x19
#define VR_ASIC_P0V85_PVDD_VOLT_V 0x1A
#define VR_ASIC_P0V85_PVDD_CURR_A 0x1B
#define VR_ASIC_P0V85_PVDD_PWR_W 0x1C

#define VR_ASIC_P0V75_PVDD_CH_N_TEMP_C 0x1D
#define VR_ASIC_P0V75_PVDD_CH_N_VOLT_V 0x1E
#define VR_ASIC_P0V75_PVDD_CH_N_CURR_A 0x1F
#define VR_ASIC_P0V75_PVDD_CH_N_PWR_W 0x20
#define VR_ASIC_P0V75_MAX_PHY_N_TEMP_C 0x21
#define VR_ASIC_P0V75_MAX_PHY_N_VOLT_V 0x22
#define VR_ASIC_P0V75_MAX_PHY_N_CURR_A 0x23
#define VR_ASIC_P0V75_MAX_PHY_N_PWR_W 0x24

#define VR_ASIC_P0V75_PVDD_CH_S_TEMP_C 0x25
#define VR_ASIC_P0V75_PVDD_CH_S_VOLT_V 0x26
#define VR_ASIC_P0V75_PVDD_CH_S_CURR_A 0x27
#define VR_ASIC_P0V75_PVDD_CH_S_PWR_W 0x28
#define VR_ASIC_P0V75_MAX_PHY_S_TEMP_C 0x29
#define VR_ASIC_P0V75_MAX_PHY_S_VOLT_V 0x2A
#define VR_ASIC_P0V75_MAX_PHY_S_CURR_A 0x2B
#define VR_ASIC_P0V75_MAX_PHY_S_PWR_W 0x2C

#define VR_ASIC_P0V75_TRVDD_ZONEA_TEMP_C 0x2D
#define VR_ASIC_P0V75_TRVDD_ZONEA_VOLT_V 0x2E
#define VR_ASIC_P0V75_TRVDD_ZONEA_CURR_A 0x2F
#define VR_ASIC_P0V75_TRVDD_ZONEA_PWR_W 0x30
#define VR_ASIC_P1V8_VPP_HBM0_HBM2_HBM4_TEMP_C 0x31
#define VR_ASIC_P1V8_VPP_HBM0_HBM2_HBM4_VOLT_V 0x32
#define VR_ASIC_P1V8_VPP_HBM0_HBM2_HBM4_CURR_A 0x33
#define VR_ASIC_P1V8_VPP_HBM0_HBM2_HBM4_PWR_W 0x34

#define VR_ASIC_P0V75_TRVDD_ZONEB_TEMP_C 0x35
#define VR_ASIC_P0V75_TRVDD_ZONEB_VOLT_V 0x36
#define VR_ASIC_P0V75_TRVDD_ZONEB_CURR_A 0x37
#define VR_ASIC_P0V75_TRVDD_ZONEB_PWR_W 0x38
#define VR_ASIC_P0V4_VDDQL_HBM0_HBM2_HBM4_TEMP_C 0x39
#define VR_ASIC_P0V4_VDDQL_HBM0_HBM2_HBM4_VOLT_V 0x3A
#define VR_ASIC_P0V4_VDDQL_HBM0_HBM2_HBM4_CURR_A 0x3B
#define VR_ASIC_P0V4_VDDQL_HBM0_HBM2_HBM4_PWR_W 0x3C

#define VR_ASIC_P1V1_VDDC_HBM0_HBM2_HBM4_TEMP_C 0x3D
#define VR_ASIC_P1V1_VDDC_HBM0_HBM2_HBM4_VOLT_V 0x3E
#define VR_ASIC_P1V1_VDDC_HBM0_HBM2_HBM4_CURR_A 0x3F
#define VR_ASIC_P1V1_VDDC_HBM0_HBM2_HBM4_PWR_W 0x40
#define VR_ASIC_P0V75_VDDPHY_HBM0_HBM2_HBM4_TEMP_C 0x41
#define VR_ASIC_P0V75_VDDPHY_HBM0_HBM2_HBM4_VOLT_V 0x42
#define VR_ASIC_P0V75_VDDPHY_HBM0_HBM2_HBM4_CURR_A 0x43
#define VR_ASIC_P0V75_VDDPHY_HBM0_HBM2_HBM4_PWR_W 0x44

#define VR_ASIC_P0V9_TRVDD_ZONEA_TEMP_C 0x45
#define VR_ASIC_P0V9_TRVDD_ZONEA_VOLT_V 0x46
#define VR_ASIC_P0V9_TRVDD_ZONEA_CURR_A 0x47
#define VR_ASIC_P0V9_TRVDD_ZONEA_PWR_W 0x48
#define VR_ASIC_P1V8_VPP_HBM1_HBM3_HBM5_TEMP_C 0x49
#define VR_ASIC_P1V8_VPP_HBM1_HBM3_HBM5_VOLT_V 0x4A
#define VR_ASIC_P1V8_VPP_HBM1_HBM3_HBM5_CURR_A 0x4B
#define VR_ASIC_P1V8_VPP_HBM1_HBM3_HBM5_PWR_W 0x4C

#define VR_ASIC_P0V9_TRVDD_ZONEB_TEMP_C 0x4D
#define VR_ASIC_P0V9_TRVDD_ZONEB_VOLT_V 0x4E
#define VR_ASIC_P0V9_TRVDD_ZONEB_CURR_A 0x4F
#define VR_ASIC_P0V9_TRVDD_ZONEB_PWR_W 0x50
#define VR_ASIC_P0V4_VDDQL_HBM1_HBM3_HBM5_TEMP_C 0x51
#define VR_ASIC_P0V4_VDDQL_HBM1_HBM3_HBM5_VOLT_V 0x52
#define VR_ASIC_P0V4_VDDQL_HBM1_HBM3_HBM5_CURR_A 0x53
#define VR_ASIC_P0V4_VDDQL_HBM1_HBM3_HBM5_PWR_W 0x54

#define VR_ASIC_P1V1_VDDC_HBM1_HBM3_HBM5_TEMP_C 0x55
#define VR_ASIC_P1V1_VDDC_HBM1_HBM3_HBM5_VOLT_V 0x56
#define VR_ASIC_P1V1_VDDC_HBM1_HBM3_HBM5_CURR_A 0x57
#define VR_ASIC_P1V1_VDDC_HBM1_HBM3_HBM5_PWR_W 0x58
#define VR_ASIC_P0V75_VDDPHY_HBM1_HBM3_HBM5_TEMP_C 0x59
#define VR_ASIC_P0V75_VDDPHY_HBM1_HBM3_HBM5_VOLT_V 0x5A
#define VR_ASIC_P0V75_VDDPHY_HBM1_HBM3_HBM5_CURR_A 0x5B
#define VR_ASIC_P0V75_VDDPHY_HBM1_HBM3_HBM5_PWR_W 0x5C

#define VR_ASIC_P0V8_VDDA_PCIE_TEMP_C 0x5D
#define VR_ASIC_P0V8_VDDA_PCIE_VOLT_V 0x5E
#define VR_ASIC_P0V8_VDDA_PCIE_CURR_A 0x5F
#define VR_ASIC_P0V8_VDDA_PCIE_PWR_W 0x60
#define VR_ASIC_P1V2_VDDHTX_PCIE_TEMP_C 0x61
#define VR_ASIC_P1V2_VDDHTX_PCIE_VOLT_V 0x62
#define VR_ASIC_P1V2_VDDHTX_PCIE_CURR_A 0x63
#define VR_ASIC_P1V2_VDDHTX_PCIE_PWR_W 0x64

#define VR_ASIC_P0V895_PEX_TEMP_C 0x65
#define VR_ASIC_P0V895_PEX_VOLT_V 0x66
#define VR_ASIC_P0V895_PEX_CURR_A 0x67
#define VR_ASIC_P0V895_PEX_PWR_W 0x68
#define VR_ASIC_P0V825_A0_TEMP_C 0x69
#define VR_ASIC_P0V825_A0_VOLT_V 0x6A
#define VR_ASIC_P0V825_A0_CURR_A 0x6B
#define VR_ASIC_P0V825_A0_PWR_W 0x6C

#define VR_ASIC_P0V825_A1_TEMP_C 0x6D
#define VR_ASIC_P0V825_A1_VOLT_V 0x6E
#define VR_ASIC_P0V825_A1_CURR_A 0x6F
#define VR_ASIC_P0V825_A1_PWR_W 0x70
#define VR_ASIC_P0V825_A2_TEMP_C 0x71
#define VR_ASIC_P0V825_A2_VOLT_V 0x72
#define VR_ASIC_P0V825_A2_CURR_A 0x73
#define VR_ASIC_P0V825_A2_PWR_W 0x74

#define PLAT_SENSOR_NUM_MAX 0x75 //Change if there is new sensor
