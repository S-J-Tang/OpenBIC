...
plat_sensor_vr_extend_info plat_sensor_vr_extend_table[] = {
	{ VR_ASIC_P0V895_PEX_TEMP_C, VR_ASIC_P0V895_PEX_ISL69260_ADDR,
	  VR_ASIC_P0V895_PEX_MP2971_ADDR },
	{ VR_ASIC_P0V895_PEX_VOLT_V, VR_ASIC_P0V895_PEX_ISL69260_ADDR,
	  VR_ASIC_P0V895_PEX_MP2971_ADDR },
	{ VR_ASIC_P0V895_PEX_CURR_A, VR_ASIC_P0V895_PEX_ISL69260_ADDR,
	  VR_ASIC_P0V895_PEX_MP2971_ADDR },
	{ VR_ASIC_P0V895_PEX_PWR_W, VR_ASIC_P0V895_PEX_ISL69260_ADDR,
	  VR_ASIC_P0V895_PEX_MP2971_ADDR },

	{ VR_ASIC_P0V825_A0_TEMP_C, VR_ASIC_P0V825_A0_ISL69260_ADDR,
	  VR_ASIC_P0V825_A0_MP2971_ADDR },
	{ VR_ASIC_P0V825_A0_VOLT_V, VR_ASIC_P0V825_A0_ISL69260_ADDR,
	  VR_ASIC_P0V825_A0_MP2971_ADDR },
	{ VR_ASIC_P0V825_A0_CURR_A, VR_ASIC_P0V825_A0_ISL69260_ADDR,
	  VR_ASIC_P0V825_A0_MP2971_ADDR },
	{ VR_ASIC_P0V825_A0_PWR_W, VR_ASIC_P0V825_A0_ISL69260_ADDR,
	  VR_ASIC_P0V825_A0_MP2971_ADDR },

	{ VR_ASIC_P0V825_A1_TEMP_C, VR_ASIC_P0V825_A1_ISL69260_ADDR,
	  VR_ASIC_P0V825_A1_MP2971_ADDR },
	{ VR_ASIC_P0V825_A1_VOLT_V, VR_ASIC_P0V825_A1_ISL69260_ADDR,
	  VR_ASIC_P0V825_A1_MP2971_ADDR },
	{ VR_ASIC_P0V825_A1_CURR_A, VR_ASIC_P0V825_A1_ISL69260_ADDR,
	  VR_ASIC_P0V825_A1_MP2971_ADDR },
	{ VR_ASIC_P0V825_A1_PWR_W, VR_ASIC_P0V825_A1_ISL69260_ADDR,
	  VR_ASIC_P0V825_A1_MP2971_ADDR },

	{ VR_ASIC_P0V825_A2_TEMP_C, VR_ASIC_P0V825_A2_ISL69260_ADDR,
	  VR_ASIC_P0V825_A2_MP2971_ADDR },
	{ VR_ASIC_P0V825_A2_VOLT_V, VR_ASIC_P0V825_A2_ISL69260_ADDR,
	  VR_ASIC_P0V825_A2_MP2971_ADDR },
	{ VR_ASIC_P0V825_A2_CURR_A, VR_ASIC_P0V825_A2_ISL69260_ADDR,
	  VR_ASIC_P0V825_A2_MP2971_ADDR },
	{ VR_ASIC_P0V825_A2_PWR_W, VR_ASIC_P0V825_A2_ISL69260_ADDR,
	  VR_ASIC_P0V825_A2_MP2971_ADDR },
};
	...
	{
		{
			...
			/***numeric sensor format***/
			0x0000, //uint16_t PLDM_terminus_handle;
			THERMAL_SENSOR_1_TEMP_C, //uint16_t sensor_id;
			0x0000, //uint16_t entity_type; //Need to check
			0x0001, //uint16_t entity_instance_number;
			0x0000, //uint16_t container_id;
			0x00, //uint8_t sensor_init; //Need to check
	...
	{
		{
			...
			/***numeric sensor format***/
			0x0000, //uint16_t PLDM_terminus_handle;
			THERMAL_SENSOR_2_TEMP_C, //uint16_t sensor_id;
			0x0000, //uint16_t entity_type; //Need to check
			0x0002, //uint16_t entity_instance_number;
			0x0000, //uint16_t container_id;
			0x00, //uint8_t sensor_init; //Need to check
				  ...
				  uint8_t *sensor_dev)
{
	...
	} else if (sensor_id >= VR_ASIC_P0V895_PEX_TEMP_C && sensor_id <= VR_ASIC_P0V825_A2_PWR_W) {
