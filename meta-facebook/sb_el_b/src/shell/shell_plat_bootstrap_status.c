...
#define NUWA0_MFIO16_BOOTSTRAP_BIT 1
#define NUWA1_MFIO16_BOOTSTRAP_BIT 0
...
static int cmd_get_bootstrap_status(const struct shell *shell, size_t argc, char **argv)
{
	...
	shell_print(shell, "NUWA0_MFIO16 : %d", (reg_status >> NUWA0_MFIO16_BOOTSTRAP_BIT)&1);
	shell_print(shell, "NUWA1_MFIO16 : %d", (reg_status >> NUWA1_MFIO16_BOOTSTRAP_BIT)&1);
