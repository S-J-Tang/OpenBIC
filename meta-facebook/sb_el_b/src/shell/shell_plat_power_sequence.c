...
power_sequence power_sequence_on_table[] = {
	...
	{ 8, NUWA1_VDD_ON_REG, "NUWA1_VDD_ON_REG", 0x00 },
	{ 9, NUWA0_VDD_ON_REG, "NUWA0_VDD_ON_REG", 0x00 },
	...
	{ 26, ARKE_CLK_100MHZ_ON_REG, "ARKE_CLK_100MHZ_ON_REG", 0x00 },
	{ 27, ARKE_CLK_48MHZ_ON_REG, "ARKE_CLK_48MHZ_ON_REG", 0x00 },
	{ 28, ARKE_CLK_312_5_MHZ_ON_REG, "ARKE_CLK_312.5MHZ_ON_REG", 0x00 },
	...
	{ 46, NUWA0_POWER_ON_RESET_PLD_L_ON_REG, "NUWA0_POWER_ON_RESET_PLD_L_ON_REG", 0x00 },
	{ 47, NUWA1_POWER_ON_RESET_PLD_L_ON_REG, "NUWA1_POWER_ON_RESET_PLD_L_ON_REG", 0x00 },
	{ 48, HAMSA_SYS_RST_PLD_L_ON_REG, "HAMSA_SYS_RST_PLD_L_ON_REG", 0x00 },
	{ 49, NUWA0_SYS_RST_PLD_L_ON_REG, "NUWA0_SYS_RST_PLD_L_ON_REG", 0x00 },
	{ 50, NUWA1_SYS_RST_PLD_L_ON_REG, "NUWA1_SYS_RST_PLD_L_ON_REG", 0x00 },
...
power_sequence power_sequence_off_table[] = {
	...
	{ 16, FM_ARKE_CLK_100MHZ_EN_N_DOWN_REG, "FM_ARKE_CLK_100MHZ_EN_N_DOWN_REG", 0x00 },
	{ 17, FM_CLK_48MHZ_EN_DOWN_REG, "FM_CLK_48MHZ_EN_DOWN_REG", 0x00 },
	{ 18, FM_ARKE_CLK_312MHZ_EN_N_DOWN_REG, "FM_ARKE_CLK_312MHZ_EN_N_DOWN_REG", 0x00 },
	...
	{ 35, NUWA0_VDD_DOWN_REG, "NUWA0_VDD_DOWN_REG", 0x00 },
	{ 36, NUWA1_VDD_DOWN_REG, "NUWA1_VDD_DOWN_REG", 0x00 },
