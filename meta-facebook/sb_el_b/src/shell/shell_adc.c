...
void cmd_adc_set_averge_times(const struct shell *shell, size_t argc, char **argv)
{
	...
	switch (idx) {
	case ADC_IDX_NUWA0_1:
		set_power_capping_time_w(CAPPING_VR_IDX_NUWA0, CAPPING_LV_IDX_LV2, time);
		break;
	case ADC_IDX_NUWA1_1:
		set_power_capping_time_w(CAPPING_VR_IDX_NUWA1, CAPPING_LV_IDX_LV2, time);
		break;
	case ADC_IDX_NUWA0_2:
		set_power_capping_time_w(CAPPING_VR_IDX_NUWA0, CAPPING_LV_IDX_LV3, time);
		break;
	case ADC_IDX_NUWA1_2:
		set_power_capping_time_w(CAPPING_VR_IDX_NUWA1, CAPPING_LV_IDX_LV3, time);
		break;
	default:
		break;
	}
...
void cmd_adc_set_ucr(const struct shell *shell, size_t argc, char **argv)
{
	...
	switch (idx) {
	case ADC_IDX_NUWA0_1:
		set_power_capping_threshold(CAPPING_VR_IDX_NUWA0, CAPPING_LV_IDX_LV2, ucr);
		break;
	case ADC_IDX_NUWA1_1:
		set_power_capping_threshold(CAPPING_VR_IDX_NUWA1, CAPPING_LV_IDX_LV2, ucr);
		break;
	case ADC_IDX_NUWA0_2:
		set_power_capping_threshold(CAPPING_VR_IDX_NUWA0, CAPPING_LV_IDX_LV3, ucr);
		break;
	case ADC_IDX_NUWA1_2:
		set_power_capping_threshold(CAPPING_VR_IDX_NUWA1, CAPPING_LV_IDX_LV3, ucr);
		break;
	default:
		break;
	}
