...
#define NUWA1_VQPS_W_EN_BIT 2
#define NUWA0_VQPS_E_EN_BIT 1
#define NUWA1_VQPS_E_EN_BIT 0
...
static const cpld_pin_map_t vqps_list[] = {
	{ "NUWA0_VQPS_TOP_EN", NUWA0_VQPS_TOP_EN_BIT, VQPS_STATUS_CPLD_OFFSET },
	{ "NUWA1_VQPS_TOP_EN", NUWA1_VQPS_TOP_EN_BIT, VQPS_STATUS_CPLD_OFFSET },
	{ "NUWA0_VQPS_U_EN", NUWA0_VQPS_U_EN_BIT, VQPS_STATUS_CPLD_OFFSET },
	{ "NUWA1_VQPS_U_EN", NUWA1_VQPS_U_EN_BIT, VQPS_STATUS_CPLD_OFFSET },
