...
ubc_vr_power_mapping_sensor ubc_vr_power_table[] = {
	...
	{ UBC_VR_RAIL_E_ASIC_P0V85_NUWA0_VDD,
	  SENSOR_NUM_ASIC_P0V85_NUWA0_VDD_PWR_W,
	  "VR_ASIC_P0V85_NUWA0_VDD_PWR_W",
	  { 0 } },
	{ UBC_VR_RAIL_E_ASIC_P0V85_NUWA1_VDD,
	  SENSOR_NUM_ASIC_P0V85_NUWA1_VDD_PWR_W,
	  "VR_ASIC_P0V85_NUWA1_VDD_PWR_W",
	  { 0 } },
