...
vr_mapping_sensor vr_rail_table[] = {
	/*
	VR_RAIL_E_ASIC_P0V85_NUWA0_VDD = 0,
	VR_RAIL_E_ASIC_P0V85_NUWA1_VDD,
	...
	*/
	{ VR_RAIL_E_ASIC_P0V85_NUWA0_VDD, SENSOR_NUM_ASIC_P0V85_NUWA0_VDD_VOLT_V,
	  "ASIC_P0V85_NUWA0_VDD", 0xffffffff },
	{ VR_RAIL_E_ASIC_P0V85_NUWA1_VDD, SENSOR_NUM_ASIC_P0V85_NUWA1_VDD_VOLT_V,
	  "ASIC_P0V85_NUWA1_VDD", 0xffffffff },
...
bootstrap_mapping_register bootstrap_table[] = {
	...
	{ STRAP_INDEX_FM_JTAG_HAMSA_JTCE_0_3, STRAP_TYPE_CPLD, 0x19, "HAMSA_JTCE_0_3", 0, 4, 0x01,
	  0x01, false },
	{ STRAP_INDEX_NUWA0_TEST_STRAP, STRAP_TYPE_CPLD, 0x1a, "NUWA0_TEST_STRAP", 4, 1, 0x0, 0x0,
	  false },
	{ STRAP_INDEX_NUWA0_CRM_STRAP_0, STRAP_TYPE_CPLD, 0x1a, "NUWA0_CRM_STRAP_0", 3, 1, 0x0,
	  0x0, true },
	{ STRAP_INDEX_NUWA0_CRM_STRAP_1, STRAP_TYPE_CPLD, 0x1a, "NUWA0_CRM_STRAP_1", 2, 1, 0x0,
	  0x0, true },
	{ STRAP_INDEX_NUWA0_CHIP_STRAP_0, STRAP_TYPE_CPLD, 0x1a, "NUWA0_CHIP_STRAP_0", 1, 1, 0x01,
	  0x01, true },
	{ STRAP_INDEX_NUWA0_CHIP_STRAP_1, STRAP_TYPE_CPLD, 0x1a, "NUWA0_CHIP_STRAP_1", 0, 1, 0x01,
	  0x01, true },
	{ STRAP_INDEX_NUWA0_CORE_TAP_CTRL_PLD_L, STRAP_TYPE_CPLD, 0x1b,
	  "NUWA0_CORE_TAP_CTRL_PLD_L", 3, 1, 0x01, 0x01, false },
	{ STRAP_INDEX_NUWA0_TRI_L, STRAP_TYPE_CPLD, 0x1b, "NUWA0_TRI_L", 2, 1, 0x01, 0x01,
	  false },
	{ STRAP_INDEX_NUWA0_ATPG_MODE_L, STRAP_TYPE_CPLD, 0x1b, "NUWA0_ATPG_MODE_L", 1, 1, 0x01,
	  0x01, false },
	{ STRAP_INDEX_NUWA0_DFT_TAP_EN_PLD_L, STRAP_TYPE_CPLD, 0x1b, "NUWA0_DFT_TAP_EN_PLD_L", 0,
	  1, 0x01, 0x01, false },
	{ STRAP_INDEX_NUWA1_TEST_STRAP, STRAP_TYPE_CPLD, 0x1c, "NUWA1_TEST_STRAP", 4, 1, 0x0, 0x0,
	  false },
	{ STRAP_INDEX_NUWA1_CRM_STRAP_0, STRAP_TYPE_CPLD, 0x1c, "NUWA1_CRM_STRAP_0", 3, 1, 0x0,
	  0x0, true },
	{ STRAP_INDEX_NUWA1_CRM_STRAP_1, STRAP_TYPE_CPLD, 0x1c, "NUWA1_CRM_STRAP_1", 2, 1, 0x0,
	  0x0, true },
	{ STRAP_INDEX_NUWA1_CHIP_STRAP_0, STRAP_TYPE_CPLD, 0x1c, "NUWA1_CHIP_STRAP_0", 1, 1, 0x01,
	  0x01, true },
	{ STRAP_INDEX_NUWA1_CHIP_STRAP_1, STRAP_TYPE_CPLD, 0x1c, "NUWA1_CHIP_STRAP_1", 0, 1, 0x01,
	  0x01, true },
	{ STRAP_INDEX_NUWA1_CORE_TAP_CTRL_PLD_L, STRAP_TYPE_CPLD, 0x1d,
	  "NUWA1_CORE_TAP_CTRL_PLD_L", 3, 1, 0x01, 0x01, false },
	{ STRAP_INDEX_NUWA1_TRI_L, STRAP_TYPE_CPLD, 0x1d, "NUWA1_TRI_L", 2, 1, 0x01, 0x01,
	  false },
	{ STRAP_INDEX_NUWA1_ATPG_MODE_L, STRAP_TYPE_CPLD, 0x1d, "NUWA1_ATPG_MODE_L", 1, 1, 0x01,
	  0x01, false },
	{ STRAP_INDEX_NUWA1_DFT_TAP_EN_PLD_L, STRAP_TYPE_CPLD, 0x1d, "NUWA1_DFT_TAP_EN_PLD_L", 0,
	  1, 0x01, 0x01, false },
	{ STRAP_INDEX_FM_JTAG_NUWA0_JTCE_0_2, STRAP_TYPE_CPLD, 0x1f, "NUWA0_JTCE_0_2", 3, 3, 0x01,
	  0x01, true },
	{ STRAP_INDEX_FM_JTAG_NUWA1_JTCE_0_2, STRAP_TYPE_CPLD, 0x1f, "NUWA1_JTCE_0_2", 0, 3, 0x01,
	  0x01, true },
