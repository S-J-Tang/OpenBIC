...
#define CONTROL_VOL_VR_ASIC_P1V05_VDDQC_HBM0246_REG 0x82
#define CONTROL_VOL_VR_ASIC_P1V05_VDDQC_HBM1357_REG 0x83
...
// #define CONTROL_VOL_VR_ASIC_P0V85_NUWA0_VDD_REG 0x88
// #define CONTROL_VOL_VR_ASIC_P0V85_NUWA1_VDD_REG 0x89
...
typedef struct __attribute__((__packed__)) {
	uint8_t device_type; // Device type (Aegis = 0x01, Electra = 0x02)
