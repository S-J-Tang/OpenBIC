...
const vr_test_mode_setting_t vr_test_mode_table[] = {
	...
	{ VR_RAIL_E_ASIC_P1V05_VDDQC_HBM1357, 3200, 3200, 200, 1320, 1310, 770, 1310, 0 },
	...
	{ VR_RAIL_E_ASIC_P1V05_VDDQC_HBM0246, 3200, 3200, 200, 1320, 1310, 770, 1310, 0 },
...
const vr_test_mode_setting_t vr_test_mode_table_default[] = {
	// vr_rail, fast ocp: x/10(A), slow ocp: x/10(A), uvp: 1(mV), ovp: 1(mV), v max: 1(mV), lcr(mV), ucr(mV), vout_default(mV)
	{ VR_RAIL_E_ASIC_P0V75_NUWA0_VDD, 14300, 14300, 640, 940, 918, 782, 918, 870 },
	{ VR_RAIL_E_ASIC_P0V75_NUWA1_VDD, 14300, 14300, 640, 940, 918, 782, 918, 870 },
	...
	{ VR_RAIL_E_ASIC_P1V05_VDDQC_HBM1357, 2800, 2700, 900, 1260, 1177, 1067, 1177, 1100 },
	...
	{ VR_RAIL_E_ASIC_P1V05_VDDQC_HBM0246, 2800, 2700, 900, 1260, 1177, 1067, 1177, 1100 },
...
const mps_vr_test_mode_setting_t vr_mps_test_mode_table[] = {
	...
	*/
	...
	NO_USE, 520, NO_USE },
	{ VR_RAIL_E_ASIC_P1V05_VDDQC_HBM1357, 318, 0, 400, 770, 1310, NO_USE, NO_USE, NO_ACTION, 1360,
	NO_USE, 1310, NO_USE },
	...
	NO_USE, 1053, NO_USE },
	{ VR_RAIL_E_ASIC_P1V05_VDDQC_HBM0246, 318, 0, 400, 770, 1310, NO_USE, NO_USE, NO_ACTION, 1360,
	NO_USE, 1310, NO_USE },
...
const mps_vr_test_mode_setting_t vr_mps_normal_mode_table[] = {
	...
	uint16_t uvp;
	*/
	{ VR_RAIL_E_ASIC_P0V75_NUWA0_VDD, 1424, NO_USE, 200, 782, 918, NO_USE, NO_USE, 977, 940,
	  850, 918, 677 },
	...
	405, 440, 330 },
	{ VR_RAIL_E_ASIC_P1V05_VDDQC_HBM1357, 270, 1, 200, 1067, 1177, NO_USE, NO_USE, 1225, 1275,
	1115, 1175, 915 },
	...
	875, 920, 675 },
	{ VR_RAIL_E_ASIC_P1V05_VDDQC_HBM0246, 270, 1, 200, 1067, 1177, NO_USE, NO_USE, 1225, 1275,
	1115, 1175, 915 },
