...
const vr_test_mode_setting_t vr_test_mode_table[] = {
	...
	{ VR_RAIL_E_ASIC_P0V85_NUWA0_VDD, 14300, 14300, 200, 940, 930, 595, 930, 0 },
	{ VR_RAIL_E_ASIC_P0V85_NUWA1_VDD, 14300, 14300, 200, 940, 930, 595, 930, 0 },
...
const vr_test_mode_setting_t vr_test_mode_table_default[] = {
	// vr_rail, fast ocp: x/10(A), slow ocp: x/10(A), uvp: 1(mV), ovp: 1(mV), v max: 1(mV), lcr(mV), ucr(mV), vout_default(mV)
	{ VR_RAIL_E_ASIC_P0V85_NUWA0_VDD, 14300, 14300, 640, 940, 918, 782, 918, 870 },
	{ VR_RAIL_E_ASIC_P0V85_NUWA1_VDD, 14300, 14300, 640, 940, 918, 782, 918, 870 },
...
const mps_vr_test_mode_setting_t vr_mps_test_mode_table[] = {
	...
	uint16_t uvp;
	*/
	{ VR_RAIL_E_ASIC_P0V85_NUWA0_VDD, 1424, NO_USE, 500, 595, 930, NO_USE, NO_USE, NO_ACTION,
	  940, NO_USE, 930 },
	{ VR_RAIL_E_ASIC_P0V85_NUWA1_VDD, 1424, NO_USE, 500, 595, 930, NO_USE, NO_USE, NO_ACTION,
	  940, NO_USE, 930 },
...
const mps_vr_test_mode_setting_t vr_mps_normal_mode_table[] = {
	...
	uint16_t uvp;
	*/
	{ VR_RAIL_E_ASIC_P0V85_NUWA0_VDD, 1424, NO_USE, 200, 782, 918, NO_USE, NO_USE, 977, 940,
	  850, 918, 677 },
	{ VR_RAIL_E_ASIC_P0V85_NUWA1_VDD, 1424, NO_USE, 200, 782, 918, NO_USE, NO_USE, 980, 940,
	  850, 918, 680 },
...
{
	switch (rail) {
	case VR_RAIL_E_ASIC_P0V85_NUWA0_VDD:
	case VR_RAIL_E_ASIC_P0V85_NUWA1_VDD:
		return false;
	default:
		return true;
	}
