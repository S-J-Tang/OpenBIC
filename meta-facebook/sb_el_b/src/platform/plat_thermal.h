...
enum ARKE_TEMP_INDEX_E {
	TEMP_STATUS_INDEX_ASIC_NUWA0_SENSOR0,
	TEMP_STATUS_INDEX_ASIC_NUWA0_SENSOR1,
	TEMP_STATUS_INDEX_ASIC_OWL_W,
	TEMP_STATUS_INDEX_ASIC_OWL_E,
	TEMP_STATUS_INDEX_ASIC_NUWA1_SENSOR0,
	TEMP_STATUS_INDEX_ASIC_NUWA1_SENSOR1,
