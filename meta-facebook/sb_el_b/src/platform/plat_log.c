...
vr_device_match_sensor_num vr_error_fault_table[] = {
	...
	//pwr fault reg 2
	{ PWRGD_NUWA1_VDD_FAULT, SENSOR_NUM_ASIC_P0V85_NUWA1_VDD_TEMP_C },
	{ PWRGD_NUWA0_VDD_FAULT, SENSOR_NUM_ASIC_P0V85_NUWA0_VDD_TEMP_C },
...
vr_smbus_alrt_sensor_map vr_smbus_alrt_sensor_map_table[] = {
	...
	{ 6, VR_RAIL_E_ASIC_P0V85_NUWA1_VDD },
	{ 7, VR_RAIL_E_ASIC_P0V85_NUWA0_VDD },
};
