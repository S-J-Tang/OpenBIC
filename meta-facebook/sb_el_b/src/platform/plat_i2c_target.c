...
voltage_rail_mapping_sensor voltage_rail_mapping_table[] = {
	...
	{ CONTROL_VOL_VR_ASIC_P1V05_VDDQC_HBM0246_REG, VR_RAIL_E_ASIC_P1V05_VDDQC_HBM0246 },
	{ CONTROL_VOL_VR_ASIC_P1V05_VDDQC_HBM1357_REG, VR_RAIL_E_ASIC_P1V05_VDDQC_HBM1357 },
...
void vr_power_reading(uint8_t *buffer, size_t buf_size)
{
	...
	[10:11] - P1V05_VDDQC_HBM0246 (Unit: W)
	[12:13] - P0V75_VDDPHY_HBM0246 (Unit: W)
	[14:15] - P1V05_VDDQC_HBM1357 (Unit: W)
	...
	*/
	...
	for (size_t i = 0; i < ARRAY_SIZE(vr_pwr_sensor_table); i++) {
		...
		case SENSOR_NUM_ASIC_P0V75_NUWA1_VDD_PWR_W:
			...
			nuwa1 = milivolt;
			break;
		case SENSOR_NUM_ASIC_P1V05_VDDQC_HBM0246_PWR_W:
			memcpy(&buffer[10], &val, 2);
			break;
		case SENSOR_NUM_ASIC_P0V75_VDDPHY_HBM0246_PWR_W:
			memcpy(&buffer[12], &val, 2);
			break;
		case SENSOR_NUM_ASIC_P1V05_VDDQC_HBM1357_PWR_W:
...
static bool command_reply_data_handle(void *arg)
{
	...
	if (data->wr_buffer_idx >= 1) {
		if (data->wr_buffer_idx == 1) {
			...
			case CONTROL_VOL_VR_ASIC_P1V05_VDDQC_HBM0246_REG:
			case CONTROL_VOL_VR_ASIC_P1V05_VDDQC_HBM1357_REG:
...
uint8_t vr_pwr_alert_table[] = {
	SENSOR_NUM_ASIC_P0V75_NUWA0_VDD_PWR_W,	  SENSOR_NUM_ASIC_P0V75_NUWA1_VDD_PWR_W,
	SENSOR_NUM_ASIC_P1V05_VDDQC_HBM0246_PWR_W, SENSOR_NUM_ASIC_P0V75_VDDPHY_HBM0246_PWR_W,
	SENSOR_NUM_ASIC_P1V05_VDDQC_HBM1357_PWR_W, SENSOR_NUM_ASIC_P0V75_VDDPHY_HBM1357_PWR_W,
