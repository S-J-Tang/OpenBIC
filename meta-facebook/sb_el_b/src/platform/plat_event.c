...
const vr_fault_info vr_fault_table[] = {
	...
	// VR Power Fault 2
	{ ARKE_NUWA1_VDD, VR_POWER_FAULT_2_REG, BIT(7), true,
	  SENSOR_NUM_ASIC_P0V75_NUWA1_VDD_VOLT_V },
	{ ARKE_NUWA0_VDD, VR_POWER_FAULT_2_REG, BIT(6), true,
	  SENSOR_NUM_ASIC_P0V75_NUWA0_VDD_VOLT_V },
	{ ARKE_OWL_E_VDD, VR_POWER_FAULT_2_REG, BIT(5), true,
	  SENSOR_NUM_ASIC_P0V75_OWL_E_VDD_VOLT_V },
	{ ARKE_OWL_W_VDD, VR_POWER_FAULT_2_REG, BIT(4), true,
	  SENSOR_NUM_ASIC_P0V75_OWL_W_VDD_VOLT_V },
	{ ARKE_HAMSA_VDD, VR_POWER_FAULT_2_REG, BIT(3), true,
	  SENSOR_NUM_ASIC_P0V85_HAMSA_VDD_VOLT_V },
	{ ARKE_MAX_S_VDD, VR_POWER_FAULT_2_REG, BIT(2), true,
	  SENSOR_NUM_ASIC_P0V75_MAX_S_VDD_VOLT_V },
	{ ARKE_MAX_M_VDD, VR_POWER_FAULT_2_REG, BIT(1), true,
	  SENSOR_NUM_ASIC_P0V75_MAX_M_VDD_VOLT_V },
	{ ARKE_MAX_N_VDD, VR_POWER_FAULT_2_REG, BIT(0), true,
