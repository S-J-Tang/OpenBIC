...
temp_mapping_sensor_t temp_alert_index_table[] = {
	{ TEMP_STATUS_INDEX_ASIC_NUWA0_SENSOR0, SENSOR_NUM_ASIC_NUWA0_SENSOR0_TEMP_C,
	  "SB_EL_ASIC_NUWA0_SENSOR0_TEMP", 0, false },
	{ TEMP_STATUS_INDEX_ASIC_NUWA0_SENSOR1, SENSOR_NUM_ASIC_NUWA0_SENSOR1_TEMP_C,
	  "SB_EL_ASIC_NUWA0_SENSOR1_TEMP", 0, false },
	{ TEMP_STATUS_INDEX_ASIC_OWL_W, SENSOR_NUM_ASIC_OWL_W_TEMP_C, "SB_EL_ASIC_OWL_W_TEMP", 0,
	  false },
	{ TEMP_STATUS_INDEX_ASIC_OWL_E, SENSOR_NUM_ASIC_OWL_E_TEMP_C, "SB_EL_ASIC_OWL_E_TEMP", 0,
	  false },
	{ TEMP_STATUS_INDEX_ASIC_NUWA1_SENSOR0, SENSOR_NUM_ASIC_NUWA1_SENSOR0_TEMP_C,
	  "SB_EL_ASIC_NUWA1_SENSOR0_TEMP", 0, false },
	{ TEMP_STATUS_INDEX_ASIC_NUWA1_SENSOR1, SENSOR_NUM_ASIC_NUWA1_SENSOR1_TEMP_C,
