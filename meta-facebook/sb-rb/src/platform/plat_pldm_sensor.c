...
static void update_ot_warning_status(void)
{
	...
	for (uint8_t i = 0; i < ot_warning_table_count; i++) {
		...
		uint8_t reg_val = 0;
		bool read_ok = get_raw_data_from_sensor_id(ot_warning_table[i].sensor_num,
							   OT_WARNING_REG, &reg_val, 1);
...
uint8_t check_sensor_type(uint8_t sensor_num)
{
	...
	if (sensor_num <= SENSOR_NUM_IRIS_MEDHA1_HBM3_REMOTE_TEMP_C)
		return TEMP_SENSOR_THREAD_ID;

	if (sensor_num <= SENSOR_NUM_ASIC_OWL_LOCAL_TEMP_C)
		return TEMP_SENSOR_THREAD_ID;

	if (sensor_num <= SENSOR_NUM_ASIC_IMON_MEDHA1_VDD_CURR_A)
		return is_quick_vr_sensor(sensor_num) ? QUICK_VR_SENSOR_THREAD_ID :
							VR_SENSOR_THREAD_ID;
...
pldm_sensor_info plat_pldm_sensor_temp_table[] = {
	...
	{
		{
			...
			/***numeric sensor format***/
			0x0000, //uint16_t PLDM_terminus_handle;
			SENSOR_NUM_IRIS_HAMSA_REMOTE_TEMP_C, //uint16_t sensor_id;
			0x0000, //uint16_t entity_type; //Need to check
			SENSOR_NUM_IRIS_HAMSA_REMOTE_TEMP_C, //uint16_t entity_instance_number;
			0x0000, //uint16_t container_id;
			0x00, //uint8_t sensor_init; //Need to check
			0x01, //uint8_t sensor_auxiliary_names_pdr;
			0x02, //uint8_t base_unit;  //unit
		...
		.update_time = 0,
		{
			.num = SENSOR_NUM_IRIS_HAMSA_REMOTE_TEMP_C,
			.type = sensor_dev_iris_smbus,
			.port = I2C_BUS12,
			.target_addr = ASIC_ADDR,
			.offset = ASIC_MONITOR_TEMP_REG,
			.access_checker = is_iris_smbus_access,
			.sample_count = SAMPLE_COUNT_DEFAULT,
			.cache = 0,
			.cache_status = PLDM_SENSOR_INITIALIZING,
	...
	},
	{
		...
		.update_time = 0,
		{
			...
			.port = I2C_BUS12,
			.target_addr = ASIC_ADDR,
			.offset = ASIC_MONITOR_HBM_TEMP_REG,
			.access_checker = is_iris_smbus_access,
			.sample_count = SAMPLE_COUNT_DEFAULT,
			.cache = 0,
			.cache_status = PLDM_SENSOR_INITIALIZING,
	...
	{
		{
			...
			/***numeric sensor format***/
			0x0000, //uint16_t PLDM_terminus_handle;
			SENSOR_NUM_ASIC_MEDHA1_LOCAL_TEMP_C, //uint16_t sensor_id;
			0x0000, //uint16_t entity_type; //Need to check
			SENSOR_NUM_ASIC_MEDHA1_LOCAL_TEMP_C, //uint16_t entity_instance_number;
			0x0000, //uint16_t container_id;
			0x00, //uint8_t sensor_init; //Need to check
			0x01, //uint8_t sensor_auxiliary_names_pdr;
			0x02, //uint8_t base_unit;  //unit
		...
		.update_time = 0,
		{
			.num = SENSOR_NUM_ASIC_MEDHA1_LOCAL_TEMP_C,
			.type = sensor_dev_tmp431,
			.port = I2C_BUS2,
			.target_addr = ASIC_MEDHA1_LOCAL_ADDR,
	...
	{
		{
			...
			/***numeric sensor format***/
			0x0000, //uint16_t PLDM_terminus_handle;
			SENSOR_NUM_ASIC_HAMSA_LOCAL_TEMP_C, //uint16_t sensor_id;
			0x0000, //uint16_t entity_type; //Need to check
			SENSOR_NUM_ASIC_HAMSA_LOCAL_TEMP_C, //uint16_t entity_instance_number;
			0x0000, //uint16_t container_id;
			0x00, //uint8_t sensor_init; //Need to check
			0x01, //uint8_t sensor_auxiliary_names_pdr;
			0x02, //uint8_t base_unit;  //unit
		...
		.update_time = 0,
		{
			.num = SENSOR_NUM_ASIC_HAMSA_LOCAL_TEMP_C,
			.type = sensor_dev_tmp431,
			.port = I2C_BUS2,
			.target_addr = ASIC_HAMSA_LOCAL_ADDR,
			.offset = TMP431_LOCAL_TEMPERATRUE,
			.access_checker = is_temp_access,
			.sample_count = SAMPLE_COUNT_DEFAULT,
			.cache = 0,
	...
	{
		{
			...
			/***numeric sensor format***/
			0x0000, //uint16_t PLDM_terminus_handle;
			SENSOR_NUM_ASIC_MEDHA0_LOCAL_TEMP_C, //uint16_t sensor_id;
			0x0000, //uint16_t entity_type; //Need to check
			SENSOR_NUM_ASIC_MEDHA0_LOCAL_TEMP_C, //uint16_t entity_instance_number;
			0x0000, //uint16_t container_id;
			0x00, //uint8_t sensor_init; //Need to check
			0x01, //uint8_t sensor_auxiliary_names_pdr;
			0x02, //uint8_t base_unit;  //unit
		...
		.update_time = 0,
		{
			.num = SENSOR_NUM_ASIC_MEDHA0_LOCAL_TEMP_C,
			.type = sensor_dev_tmp431,
			.port = I2C_BUS3,
			.target_addr = ASIC_MEDHA0_LOCAL_ADDR,
			.offset = TMP431_LOCAL_TEMPERATRUE,
			.access_checker = is_temp_access,
			.sample_count = SAMPLE_COUNT_DEFAULT,
			.cache = 0,
	...
	{
		{
			...
			/***numeric sensor format***/
			0x0000, //uint16_t PLDM_terminus_handle;
			SENSOR_NUM_ASIC_OWL_LOCAL_TEMP_C, //uint16_t sensor_id;
			0x0000, //uint16_t entity_type; //Need to check
			SENSOR_NUM_ASIC_OWL_LOCAL_TEMP_C, //uint16_t entity_instance_number;
			0x0000, //uint16_t container_id;
			0x00, //uint8_t sensor_init; //Need to check
			0x01, //uint8_t sensor_auxiliary_names_pdr;
			0x02, //uint8_t base_unit;  //unit
		...
		.update_time = 0,
		{
			...
			.type = sensor_dev_tmp431,
			.port = I2C_BUS3,
			.target_addr = ASIC_OWL_LOCAL_ADDR,
			.offset = TMP431_LOCAL_TEMPERATRUE,
			.access_checker = is_temp_access,
			.sample_count = SAMPLE_COUNT_DEFAULT,
			.cache = 0,
	...
	{
		{
			...
			0, //uint32_t warning_low;
			1420000, //uint32_t critical_high;
			0, //uint32_t critical_low;
			0, //uint32_t fatal_high;
			0, //uint32_t fatal_low;
		},
	...
	{
		{
			...
			/***numeric sensor format***/
			0x0000, //uint16_t PLDM_terminus_handle;
			SENSOR_NUM_ASIC_IMON_MEDHA0_VDD_CURR_A, //uint16_t sensor_id;
			0x0000, //uint16_t entity_type; //Need to check
			SENSOR_NUM_ASIC_IMON_MEDHA0_VDD_CURR_A, //uint16_t entity_instance_number;
			0x0000, //uint16_t container_id;
			0x00, //uint8_t sensor_init; //Need to check
			0x01, //uint8_t sensor_auxiliary_names_pdr;
			0x06, //uint8_t base_unit;  //unit
		...
		.update_time = 0,
		{
			.num = SENSOR_NUM_ASIC_IMON_MEDHA0_VDD_CURR_A,
	...
	{
		{
			...
			/***numeric sensor format***/
			0x0000, //uint16_t PLDM_terminus_handle;
			SENSOR_NUM_ASIC_IMON_MEDHA1_VDD_CURR_A, //uint16_t sensor_id;
			0x0000, //uint16_t entity_type; //Need to check
			SENSOR_NUM_ASIC_IMON_MEDHA1_VDD_CURR_A, //uint16_t entity_instance_number;
			0x0000, //uint16_t container_id;
			0x00, //uint8_t sensor_init; //Need to check
			0x01, //uint8_t sensor_auxiliary_names_pdr;
			0x06, //uint8_t base_unit;  //unit
		...
		.update_time = 0,
		{
			.num = SENSOR_NUM_ASIC_IMON_MEDHA1_VDD_CURR_A,
			.type = sensor_dev_virtual_device,
			.port = I2C_BUS1,
	...
	{
		{
			...
			0, //uint32_t warning_high;
			0, //uint32_t warning_low;
			940, //uint32_t critical_high;
			653, //uint32_t critical_low;
			0, //uint32_t fatal_high;
			0, //uint32_t fatal_low;
		},
		.update_time = 0,
	...
	{
		{
			...
			0, //uint32_t warning_high;
			0, //uint32_t warning_low;
			14300, //uint32_t critical_high;
			10350, //uint32_t critical_low;
			0, //uint32_t fatal_high;
			0, //uint32_t fatal_low;
		},
		.update_time = 0,
...
PDR_sensor_auxiliary_names plat_pdr_sensor_aux_names_table[] = {
	...
	},
	{
		...
		.nameStringCount = 0x1,
		.nameLanguageTag = "en",
		.sensorName = u"ASIC_MEDHA0_SENSOR0_TEMP_C",
	},
	{
		{
			.record_handle = 0x00000000,
		...
		.nameStringCount = 0x1,
		.nameLanguageTag = "en",
		.sensorName = u"ASIC_MEDHA0_SENSOR1_TEMP_C",
	},
	{
		{
			.record_handle = 0x00000000,
	...
	},
	{
		...
		.nameStringCount = 0x1,
		.nameLanguageTag = "en",
		.sensorName = u"ASIC_MEDHA1_SENSOR0_TEMP_C",
	},
	{
		{
			.record_handle = 0x00000000,
		...
		.nameStringCount = 0x1,
		.nameLanguageTag = "en",
		.sensorName = u"ASIC_MEDHA1_SENSOR1_TEMP_C",
	},
	{
		{
			.record_handle = 0x00000000,
	...
	},
	{
		...
		.nameStringCount = 0x1,
		.nameLanguageTag = "en",
		.sensorName = u"ASIC_P0V85_MEDHA0_VDD_VOLT_V",
	},
	{
		{
			.record_handle = 0x00000000,
		...
		.nameStringCount = 0x1,
		.nameLanguageTag = "en",
		.sensorName = u"ASIC_P0V85_MEDHA0_VDD_CURR_A",
	},
	{
		{
			.record_handle = 0x00000000,
		...
		.nameStringCount = 0x1,
		.nameLanguageTag = "en",
		.sensorName = u"ASIC_P0V85_MEDHA0_VDD_PWR_W",
	},
	{
		{
			.record_handle = 0x00000000,
		...
		.nameStringCount = 0x1,
		.nameLanguageTag = "en",
		.sensorName = u"ASIC_P0V85_MEDHA1_VDD_TEMP_C",
	},
	{
		{
			.record_handle = 0x00000000,
		...
		.nameStringCount = 0x1,
		.nameLanguageTag = "en",
		.sensorName = u"ASIC_P0V85_MEDHA1_VDD_VOLT_V",
	},
	{
		{
			.record_handle = 0x00000000,
	...
	},
	{
		...
		.terminus_handle = 0x0000,
		.sensor_id = SENSOR_NUM_IRIS_HAMSA_REMOTE_TEMP_C,
		.sensor_count = 0x1,
		.nameStringCount = 0x1,
		.nameLanguageTag = "en",
		.sensorName = u"IRIS_HAMSA_REMOTE_TEMP_C",
	},
	{
		{
			.record_handle = 0x00000000,
	...
	},
	{
		...
		.terminus_handle = 0x0000,
		.sensor_id = SENSOR_NUM_ASIC_MEDHA1_LOCAL_TEMP_C,
		.sensor_count = 0x1,
		.nameStringCount = 0x1,
		.nameLanguageTag = "en",
		.sensorName = u"ASIC_MEDHA1_LOCAL_TEMP_C",
	},
	{
		{
			.record_handle = 0x00000000,
		...
		.terminus_handle = 0x0000,
		.sensor_id = SENSOR_NUM_ASIC_HAMSA_LOCAL_TEMP_C,
		.sensor_count = 0x1,
		.nameStringCount = 0x1,
		.nameLanguageTag = "en",
		.sensorName = u"ASIC_HAMSA_LOCAL_TEMP_C",
	},
	{
		{
			.record_handle = 0x00000000,
		...
		.terminus_handle = 0x0000,
		.sensor_id = SENSOR_NUM_ASIC_MEDHA0_LOCAL_TEMP_C,
		.sensor_count = 0x1,
		.nameStringCount = 0x1,
		.nameLanguageTag = "en",
		.sensorName = u"ASIC_MEDHA0_LOCAL_TEMP_C",
	},
	{
		{
			.record_handle = 0x00000000,
		...
		.terminus_handle = 0x0000,
		.sensor_id = SENSOR_NUM_ASIC_OWL_LOCAL_TEMP_C,
		.sensor_count = 0x1,
		.nameStringCount = 0x1,
		.nameLanguageTag = "en",
		.sensorName = u"ASIC_OWL_LOCAL_TEMP_C",
	},
	{
		{
			.record_handle = 0x00000000,
		...
		.terminus_handle = 0x0000,
		.sensor_id = SENSOR_NUM_ASIC_IMON_MEDHA0_VDD_CURR_A,
		.sensor_count = 0x1,
		.nameStringCount = 0x1,
		.nameLanguageTag = "en",
		.sensorName = u"ASIC_IMON_MEDHA0_VDD_CURR_A",
	},
	{
		{
			.record_handle = 0x00000000,
		...
		.terminus_handle = 0x0000,
		.sensor_id = SENSOR_NUM_ASIC_IMON_MEDHA1_VDD_CURR_A,
		.sensor_count = 0x1,
		.nameStringCount = 0x1,
		.nameLanguageTag = "en",
		.sensorName = u"ASIC_IMON_MEDHA1_VDD_CURR_A",
	},
};
...
int plat_pldm_sensor_get_sensor_count(int thread_id)
{
	...
	case UBC_SENSOR_THREAD_ID:
		if (get_asic_board_id() == ASIC_BOARD_ID_EVB)
			...
			count = ARRAY_SIZE(plat_pldm_sensor_ubc_table) - 4;
		break;
	default:
		count = -1;
		LOG_ERR("Unknow pldm sensor thread id %d", thread_id);
...
bool is_iris_smbus_access(uint8_t sensor_num)
{
	return (is_dc_access(sensor_num) && get_plat_sensor_temp_polling_enable_flag() &&
		get_plat_sensor_polling_enable_flag() && is_update_state_idle() &&
		gpio_get(I3C_RAINBOW_ALERT_R_N) == GPIO_LOW);
}
...
temp_sensor_change_cfg change_mapping_table[] = {
	...
	{ SENSOR_NUM_ASIC_MEDHA1_LOCAL_TEMP_C, ASIC_MEDHA1_LOCAL_2ND_ADDR,
	  EMC1413_LOCAL_TEMPERATRUE },
	{ SENSOR_NUM_ASIC_HAMSA_LOCAL_TEMP_C, ASIC_HAMSA_LOCAL_2ND_ADDR,
	  EMC1413_LOCAL_TEMPERATRUE },
	{ SENSOR_NUM_ASIC_MEDHA0_LOCAL_TEMP_C, ASIC_MEDHA0_LOCAL_2ND_ADDR,
	  EMC1413_LOCAL_TEMPERATRUE },
	{ SENSOR_NUM_ASIC_OWL_LOCAL_TEMP_C, ASIC_OWL_LOCAL_2ND_ADDR, EMC1413_LOCAL_TEMPERATRUE },
};
