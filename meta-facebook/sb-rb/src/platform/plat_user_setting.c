...
temp_threshold_mapping_sensor temp_index_threshold_type_table[] = {
	...
	{ ASIC_MEDHA1_LOCAL_LOW_LIMIT, LOCAL_LOW_LIMIT, SENSOR_NUM_ASIC_MEDHA1_LOCAL_TEMP_C,
	  "SB_RB_ASIC_MEDHA1_LOCAL_TEMP_LOW_LIM" },
	{ ASIC_MEDHA1_LOCAL_HIGH_LIMIT, LOCAL_HIGH_LIMIT, SENSOR_NUM_ASIC_MEDHA1_LOCAL_TEMP_C,
	  "SB_RB_ASIC_MEDHA1_LOCAL_TEMP_HIGH_LIM" },
	{ ASIC_HAMSA_LOCAL_LOW_LIMIT, LOCAL_LOW_LIMIT, SENSOR_NUM_ASIC_HAMSA_LOCAL_TEMP_C,
	  "SB_RB_ASIC_HAMSA_LOCAL_TEMP_LOW_LIM" },
	{ ASIC_HAMSA_LOCAL_HIGH_LIMIT, LOCAL_HIGH_LIMIT, SENSOR_NUM_ASIC_HAMSA_LOCAL_TEMP_C,
	  "SB_RB_ASIC_HAMSA_LOCAL_TEMP_HIGH_LIM" },
	{ ASIC_MEDHA0_LOCAL_LOW_LIMIT, LOCAL_LOW_LIMIT, SENSOR_NUM_ASIC_MEDHA0_LOCAL_TEMP_C,
	  "SB_RB_ASIC_MEDHA0_LOCAL_TEMP_LOW_LIM" },
	{ ASIC_MEDHA0_LOCAL_HIGH_LIMIT, LOCAL_HIGH_LIMIT, SENSOR_NUM_ASIC_MEDHA0_LOCAL_TEMP_C,
	  "SB_RB_ASIC_MEDHA0_LOCAL_TEMP_HIGH_LIM" },
	{ ASIC_OWL_LOCAL_LOW_LIMIT, LOCAL_LOW_LIMIT, SENSOR_NUM_ASIC_OWL_LOCAL_TEMP_C,
	  "SB_RB_ASIC_OWL_LOCAL_TEMP_LOW_LIM" },
	{ ASIC_OWL_LOCAL_HIGH_LIMIT, LOCAL_HIGH_LIMIT, SENSOR_NUM_ASIC_OWL_LOCAL_TEMP_C,
	  "SB_RB_ASIC_OWL_LOCAL_TEMP_HIGH_LIM" },
};
