...
aegis_compnt_mapping_sensor aegis_vr_compnt_mapping_sensor_table[] = {
	{ RB_COMPNT_MEDHA0_VDD, SENSOR_NUM_MEDHA0_VDD_TEMP_C, "RB_MEDHA0_VDD" },
	{ RB_COMPNT_MEDHA1_VDD, SENSOR_NUM_MEDHA1_VDD_TEMP_C, "RB_MEDHA1_VDD" },
	{ RB_COMPNT_P075_OWL_VDD, SENSOR_NUM_P075_OWL_VDD_TEMP_C, "RB_P075_OWL_VDD" },
	{ RB_COMPNT_VDDQC_HBM1_HBM3_HBM5_HBM7, SENSOR_NUM_VDDQC_HBM1_HBM3_HBM5_HBM7_TEMP_C,
	  "RB_VDDQC_HBM1_HBM3_HBM5_HBM7" },
	{ RB_COMPNT_VDDPHY_HBM1_HBM3_HBM5_HBM7, SENSOR_NUM_VDDPHY_HBM1_HBM3_HBM5_HBM7_TEMP_C,
	  "RB_VDDPHY_HBM1_HBM3_HBM5_HBM7" },
	{ RB_COMPNT_P0V75_TRVDD, SENSOR_NUM_P0V75_TRVDD_TEMP_C, "RB_P0V75_TRVDD" },
	{ RB_COMPNT_HAMSA_VDD, SENSOR_NUM_HAMSA_VDD_TEMP_C, "RB_HAMSA_VDD" },
	{ RB_COMPNT_VPP_HBM0_HBM2_HBM4_HBM6, SENSOR_NUM_VPP_HBM0_HBM2_HBM4_HBM6_TEMP_C,
	  "RB_VPP_HBM0_HBM2_HBM4_HBM6" },
	{ RB_COMPNT_P0V85_VDDA_PCIE, SENSOR_NUM_P0V85_VDDA_PCIE_TEMP_C, "RB_P0V85_VDDA_PCIE" },
	{ RB_COMPNT_VDDQC_HBM0_HBM2_HBM4_HBM6, SENSOR_NUM_VDDQC_HBM0_HBM2_HBM4_HBM6_TEMP_C,
	  "RB_VDDQC_HBM0_HBM2_HBM4_HBM6" },
	{ RB_COMPNT_VDDPHY_HBM0_HBM2_HBM4_HBM6, SENSOR_NUM_VDDPHY_HBM0_HBM2_HBM4_HBM6_TEMP_C,
...
pldm_fw_update_info_t PLDMUPDATE_FW_CONFIG_TABLE[] = {
	...
	},
	{
		.enable = true,
		.comp_classification = COMP_CLASS_TYPE_DOWNSTREAM,
		.comp_identifier = RB_COMPNT_MEDHA0_VDD,
		.comp_classification_index = 0x00,
	...
	},
	{
		.enable = true,
		.comp_classification = COMP_CLASS_TYPE_DOWNSTREAM,
		.comp_identifier = RB_COMPNT_MEDHA1_VDD,
		.comp_classification_index = 0x00,
		.pre_update_func = pldm_pre_vr_update,
		.update_func = pldm_vr_update,
		.pos_update_func = pldm_post_vr_update,
	...
	},
	{
		.enable = true,
		.comp_classification = COMP_CLASS_TYPE_DOWNSTREAM,
		.comp_identifier = RB_COMPNT_P075_OWL_VDD,
		.comp_classification_index = 0x00,
		.pre_update_func = pldm_pre_vr_update,
		.update_func = pldm_vr_update,
		.pos_update_func = pldm_post_vr_update,
	...
	},
	{
		.enable = true,
		.comp_classification = COMP_CLASS_TYPE_DOWNSTREAM,
		.comp_identifier = RB_COMPNT_VDDQC_HBM1_HBM3_HBM5_HBM7,
		.comp_classification_index = 0x00,
		.pre_update_func = pldm_pre_vr_update,
		.update_func = pldm_vr_update,
		.pos_update_func = pldm_post_vr_update,
	...
	},
	{
		.enable = true,
		.comp_classification = COMP_CLASS_TYPE_DOWNSTREAM,
		.comp_identifier = RB_COMPNT_VDDPHY_HBM1_HBM3_HBM5_HBM7,
		.comp_classification_index = 0x00,
		.pre_update_func = pldm_pre_vr_update,
		.update_func = pldm_vr_update,
		.pos_update_func = pldm_post_vr_update,
	...
	},
	{
		.enable = true,
		.comp_classification = COMP_CLASS_TYPE_DOWNSTREAM,
		.comp_identifier = RB_COMPNT_P0V75_TRVDD,
		.comp_classification_index = 0x00,
		.pre_update_func = pldm_pre_vr_update,
		.update_func = pldm_vr_update,
		.pos_update_func = pldm_post_vr_update,
	...
	},
	{
		.enable = true,
		.comp_classification = COMP_CLASS_TYPE_DOWNSTREAM,
		.comp_identifier = RB_COMPNT_HAMSA_VDD,
		.comp_classification_index = 0x00,
		.pre_update_func = pldm_pre_vr_update,
		.update_func = pldm_vr_update,
		.pos_update_func = pldm_post_vr_update,
	...
	},
	{
		.enable = true,
		.comp_classification = COMP_CLASS_TYPE_DOWNSTREAM,
		.comp_identifier = RB_COMPNT_VPP_HBM0_HBM2_HBM4_HBM6,
		.comp_classification_index = 0x00,
		.pre_update_func = pldm_pre_vr_update,
		.update_func = pldm_vr_update,
		.pos_update_func = pldm_post_vr_update,
	...
	},
	{
		.enable = true,
		.comp_classification = COMP_CLASS_TYPE_DOWNSTREAM,
		.comp_identifier = RB_COMPNT_P0V85_VDDA_PCIE,
		.comp_classification_index = 0x00,
		.pre_update_func = pldm_pre_vr_update,
		.update_func = pldm_vr_update,
		.pos_update_func = pldm_post_vr_update,
	...
	},
	{
		.enable = true,
		.comp_classification = COMP_CLASS_TYPE_DOWNSTREAM,
		.comp_identifier = RB_COMPNT_VDDQC_HBM0_HBM2_HBM4_HBM6,
		.comp_classification_index = 0x00,
		.pre_update_func = pldm_pre_vr_update,
		.update_func = pldm_vr_update,
		.pos_update_func = pldm_post_vr_update,
	...
	},
	{
		.enable = true,
		.comp_classification = COMP_CLASS_TYPE_DOWNSTREAM,
		.comp_identifier = RB_COMPNT_VDDPHY_HBM0_HBM2_HBM4_HBM6,
		.comp_classification_index = 0x00,
		.pre_update_func = pldm_pre_vr_update,
		.update_func = pldm_vr_update,
		.pos_update_func = pldm_post_vr_update,
...
static struct k_mutex *get_vr_mutex_by_comp_id(uint8_t comp_id)
{
	...
	switch (comp_id) {
	case RB_COMPNT_MEDHA0_VDD:
		vr_mutex_id = VR_INDEX_E_MEDHA0_VDD;
		break;
	case RB_COMPNT_MEDHA1_VDD:
		vr_mutex_id = VR_INDEX_E_MEDHA1_VDD;
		break;
	case RB_COMPNT_P075_OWL_VDD:
		vr_mutex_id = VR_INDEX_E_P075_OWL_VDD;
		break;
	case RB_COMPNT_VDDQC_HBM1_HBM3_HBM5_HBM7:
		vr_mutex_id = VR_INDEX_E_VDDQC_HBM1_HBM3_HBM5_HBM7;
		break;
	case RB_COMPNT_VDDPHY_HBM1_HBM3_HBM5_HBM7:
		vr_mutex_id = VR_INDEX_E_VDDPHY_HBM1_HBM3_HBM5_HBM7;
		break;
	case RB_COMPNT_P0V75_TRVDD:
		vr_mutex_id = VR_INDEX_E_P0V75_TRVDD;
		break;
	case RB_COMPNT_HAMSA_VDD:
		vr_mutex_id = VR_INDEX_E_HAMSA_VDD;
		break;
	case RB_COMPNT_VPP_HBM0_HBM2_HBM4_HBM6:
		vr_mutex_id = VR_INDEX_E_VPP_HBM0_HBM2_HBM4_HBM6;
		break;
	case RB_COMPNT_P0V85_VDDA_PCIE:
		vr_mutex_id = VR_INDEX_E_P0V85_VDDA_PCIE;
		break;
	case RB_COMPNT_VDDQC_HBM0_HBM2_HBM4_HBM6:
		vr_mutex_id = VR_INDEX_E_VDDQC_HBM0_HBM2_HBM4_HBM6;
		break;
	case RB_COMPNT_VDDPHY_HBM0_HBM2_HBM4_HBM6:
		vr_mutex_id = VR_INDEX_E_VDDPHY_HBM0_HBM2_HBM4_HBM6;
		break;
	default:
