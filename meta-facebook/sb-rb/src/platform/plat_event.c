...
const vr_fault_info vr_fault_table[] = {
	...
	// ASIC TEMP OVER
	{ IRIS_TEMP_MON2_OVERT_N, ASIC_TEMP_OVER_REG, BIT(3), false },
	{ IRIS_TEMP_MON3_OVERT_N, ASIC_TEMP_OVER_REG, BIT(4), false },
	{ IRIS_TEMP_MON4_OVERT_N, ASIC_TEMP_OVER_REG, BIT(5), false },
	{ IRIS_TEMP_MON5_OVERT_N, ASIC_TEMP_OVER_REG, BIT(6), false },
	{ IRIS_ASIC_THERMTRIP, ASIC_TEMP_OVER_REG, BIT(7), false },
	// TEMP IC OVER FAULT
	{ IRIS_IRQ_TMP75_3_ALERT_R_N, TEMP_IC_OVER_FAULT_REG, BIT(5), false },
	{ IRIS_IRQ_TMP75_2_ALERT_R_N, TEMP_IC_OVER_FAULT_REG, BIT(6), false },
	{ IRIS_IRQ_TMP75_1_ALERT_R_N, TEMP_IC_OVER_FAULT_REG, BIT(7), false },
	// HBM CATTRIP
