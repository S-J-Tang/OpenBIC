...
enum iris_event_source {
	...
	// ASIC TEMP OVER
	// TEMP IC OVER FAULT
	IRIS_TEMP_MON2_OVERT_N = 0x75,
	IRIS_TEMP_MON3_OVERT_N,
	IRIS_TEMP_MON4_OVERT_N,
	IRIS_TEMP_MON5_OVERT_N,
	IRIS_IRQ_TMP75_3_ALERT_R_N,
	IRIS_IRQ_TMP75_2_ALERT_R_N,
	IRIS_IRQ_TMP75_1_ALERT_R_N,
};
